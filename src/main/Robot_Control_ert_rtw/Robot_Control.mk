...
COMPILER_COMMAND_FILE     = Robot_Control_comp.rsp
CMD_FILE                  = Robot_Control.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Robot_Control.exe
...
DEFINES_STANDARD = -DMODEL=Robot_Control -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/Robot_Control_ert_rtw/Robot_Control.c $(START_DIR)/Robot_Control_ert_rtw/Robot_Control_data.c
...
OBJS = Robot_Control.obj Robot_Control_data.obj
...
%.obj : $(START_DIR)/Robot_Control_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Robot_Control_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Robot_Control_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Robot_Control_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Robot_Control_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Robot_Control.obj : $(START_DIR)/Robot_Control_ert_rtw/Robot_Control.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Robot_Control_data.obj : $(START_DIR)/Robot_Control_ert_rtw/Robot_Control_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
