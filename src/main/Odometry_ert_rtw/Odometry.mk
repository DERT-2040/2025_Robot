###########################################################################
## Makefile generated for component 'Odometry'. 
## 
## Makefile     : Odometry.mk
## Generated on : Sat Dec 13 19:33:46 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Odometry.exe
...
COMPILER_COMMAND_FILE     = Odometry_comp.rsp
CMD_FILE                  = Odometry.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Odometry.exe
...
DEFINES_STANDARD = -DMODEL=Odometry -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/Odometry_ert_rtw/Odometry.c
...
%.obj : $(START_DIR)/Odometry_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Odometry_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Odometry_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Odometry_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Odometry_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Odometry.obj : $(START_DIR)/Odometry_ert_rtw/Odometry.c
	$(CC) $(CFLAGS) -o "$@" "$<"
