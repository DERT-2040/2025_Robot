...
#define Code_Gen_M_IN_NO_ACTIVE_CHILD_b ((uint8_T)0U)
...
#define Code_Gen_M_IN_Wait_for_Teleop_a ((uint8_T)16U)
...
#define Code_Gen_Model_IN_Set_L4_a     ((uint8_T)1U)
...
#define IN_Back_Up_from_Reef_Coral_Sc_h ((uint8_T)3U)
...
static void Code_Gen_Model_End_Game_Climb(boolean_T rtu_Gamepad_Start, boolean_T
  ...
  *rty_Coral_Wheel_DC, uint8_T *rty_Set_Algae_Level,
  DW_Reefscape_Chart_Code_Gen_M_T *localDW);
static void Code_Gen_Model_Set_Level_c(boolean_T rtu_Gamepad_B1_A, boolean_T
  rtu_Gamepad_B2_B, boolean_T rtu_Gamepad_B3_X, boolean_T rtu_Gamepad_B4_Y,
  DW_Reefscape_Chart_Code_Gen_M_T *localDW);
...
{
  /* Chart: '<S9>/Debounce' */
  if (localDW->is_active_c3_Controls_Component == 0) {
      ...
      if (!rtu_Coral_Limit_Switch) {
        ...
        *rty_Coral_Wheel_DC = Coral_Motor_DC_Eject;
        ...
        if (rtu_Coral_Arm_Angle_Measured < Coral_Arm_Angle_L4_Eject_Auto) {
          localDW->is_Level_4_Auto = Code_G_IN_Auto_Lower_Elevator_i;
          *rty_Elevator_Height_Desired += Elevator_Height_Coral_Score_Lower_Rate;
        } else {
          *rty_Coral_Arm_Angle_Desired += Coral_Arm_Angle_Coral_Score_Lower_Rate;
        }
  ...
  *rty_Set_Coral_Level, DW_Reefscape_Chart_Code_Gen_M_T *localDW)
{
  if ((localDW->Set_L1) || rtu_Gamepad_B1_A) {
    ...
    *rty_Coral_Arm_Angle_Desired = Coral_Arm_Angle_L4;
    ...
    localDW->is_Coral_Score_Position = Code_Gen_IN_Manual_Adjustment_p;
    *rty_State_ID = 2.5;
    *rty_Elevator_Height_Desired += rtu_Gamepad_Stick_Right_Y *
      Elevator_Height_Manual_Gain;
    *rty_Coral_Arm_Angle_Desired += rtu_Gamepad_Stick_Left_Y *
...
static void Code_Gen_Model_Set_Level_c(boolean_T rtu_Gamepad_B1_A, boolean_T
  ...
  DW_Reefscape_Chart_Code_Gen_M_T *localDW)
{
  switch (localDW->is_Set_Level_f) {
   case Code_Gen_Model_IN_L1:
    if ((rtu_Gamepad_B3_X || rtu_Gamepad_B2_B) || rtu_Gamepad_B4_Y) {
      if (rtu_Gamepad_B1_A) {
        localDW->is_Set_Level_f = Code_Gen_Model_IN_L1;
        localDW->Set_L1 = true;
        localDW->Set_L2 = false;
        localDW->Set_L3 = false;
        localDW->Set_L4 = false;
      } else if (rtu_Gamepad_B3_X) {
        localDW->is_Set_Level_f = Code_Gen_Model_IN_L2;
        localDW->Set_L1 = false;
        localDW->Set_L2 = true;
        localDW->Set_L3 = false;
        localDW->Set_L4 = false;
      } else if (rtu_Gamepad_B2_B) {
        localDW->is_Set_Level_f = Code_Gen_Model_IN_L3;
        localDW->Set_L1 = false;
        localDW->Set_L2 = false;
        localDW->Set_L3 = true;
        localDW->Set_L4 = false;
      } else if (rtu_Gamepad_B4_Y) {
        localDW->is_Set_Level_f = Code_Gen_Model_IN_L4;
        localDW->Set_L1 = false;
        localDW->Set_L2 = false;
        localDW->Set_L3 = false;
        localDW->Set_L4 = true;
  ...
  switch (localDW->is_Elevator_CoralArm_CoralWheel) {
    ...
    *rty_State_ID = 0.0;
    if (((((rtu_GameState == 1) && (localDW->Set_L1)) || (localDW->Set_L2)) ||
      ...
      localDW->is_Set_Level_f = Code_Gen_Mod_IN_NO_ACTIVE_CHILD;
      ...
      *rty_Coral_Wheel_DC = 0.0;
      ...
      Code_Gen_Model_Set_Level_c(rtu_Gamepad_B1_A, rtu_Gamepad_B2_B,
        rtu_Gamepad_B3_X, rtu_Gamepad_B4_Y, localDW);
    }
    break;
  ...
  *rty_Coral_Score, DW_Reefscape_Chart_Code_Gen_M_T *localDW)
{
  ...
  if (localDW->is_active_c5_Code_Gen_Model == 0) {
    ...
    *rty_Coral_Arm_Angle_Desired = Coral_Arm_Angle_Up;
    *rty_Coral_Wheel_DC = 0.0;
    localDW->is_Set_Level_f = Code_Gen_Model_IN_None;
    localDW->Set_L1 = false;
    localDW->Set_L2 = false;
    localDW->Set_L3 = false;
    localDW->Set_L4 = false;
  ...
  *Robot_Reached_Destination, boolean_T *Path_Enable)
{
  ...
  *Path_Enable = true;
  Code_Gen_Model_B.Translation_Speed_g = 0.0;
  Code_Gen_Model_B.Translation_Angle_n = 0.0;
  if (Code_Gen_Model_DW.is_Path_to_Reef_3 == Code_Gen_Model_IN_Set_L4_a) {
    if (*Robot_Reached_Destination) {
      Code_Gen_Model_B.Gamepad_B4_Y_out = false;
      Code_Gen_Model_DW.is_Path_to_Reef_3 = Code_Gen_M_IN_NO_ACTIVE_CHILD_b;
      Code_Gen_Model_DW.is_Left_and_Right = Code_Gen_Mod_IN_Score_at_Reef_3;
      Code_Gen_Model_B.Auto_Step_ID = 12U;
      *Path_Enable = false;
      Code_Gen_Model_B.Align_Right_o = true;
    }

    /* case IN_Timer_to_L4: */
  } else if (Code_Gen_Model_DW.timer >= Auto_Path2_Delay_to_L4_Time) {
    Code_Gen_Model_DW.is_Path_to_Reef_3 = Code_Gen_Model_IN_Set_L4_a;
    Code_Gen_Model_B.Gamepad_B4_Y_out = true;
  } else {
    Code_Gen_Model_DW.timer += 0.02;
  }
  ...
  boolean_T *Path_Enable, const uint8_T *Switch6, const uint8_T *Switch9)
{
  switch (Code_Gen_Model_DW.is_Left_and_Right) {
    ...
    *Path_Enable = false;
    ...
    Code_Gen_Model_B.Translation_Angle_n = 3.1415926535897931;
    ...
    *Path_Enable = true;
    ...
    if (*Robot_Reached_Destination) {
      ...
      Code_Gen_Model_DW.is_Left_and_Right = Code_Gen_M_IN_Wait_for_Teleop_a;
    ...
    *Path_Enable = true;
    Code_Gen_Model_B.Translation_Speed_g = 0.0;
    Code_Gen_Model_B.Translation_Angle_n = 0.0;
    if (Code_Gen_Model_DW.is_Path_to_Reef_2 == Code_Gen_Model_IN_Set_L4_a) {
      if (*Robot_Reached_Destination) {
        Code_Gen_Model_B.Gamepad_B4_Y_out = false;
        Code_Gen_Model_DW.is_Path_to_Reef_2 = Code_Gen_M_IN_NO_ACTIVE_CHILD_b;
      ...
      Code_Gen_Model_DW.is_Path_to_Reef_2 = Code_Gen_Model_IN_Set_L4_a;
      Code_Gen_Model_B.Gamepad_B4_Y_out = true;
    } else {
      Code_Gen_Model_DW.timer += 0.02;
    }
    ...
    *Path_Enable = false;
    ...
    if (Code_Gen_Model_B.UnitDelay1) {
      Code_Gen_Model_B.Align_Left_e = false;
    ...
    *Path_Enable = false;
    ...
    Code_Gen_Model_B.Translation_Angle_n = 0.0;
    if (Code_Gen_Model_B.UnitDelay1) {
      Code_Gen_Model_B.Align_Right_o = false;
...
void Code_Gen_Model_step(void)
{
   ...
   *  Store in Global RAM
   */
  rtb_Subtract_hf = (Code_Gen_Model_U.BackRight_Drive_Motor_Rev -
  ...
  rtb_TmpSignalConversionAtProduc[5] = rtb_Init * sin
    (Code_Gen_Model_B.BL_Steer_Module_Angle);
  rtb_TmpSignalConversionAtProduc[6] = rtb_Subtract_hf * cos
    (Code_Gen_Model_B.BR_Steer_Module_Angle);
  rtb_TmpSignalConversionAtProduc[7] = rtb_Subtract_hf * sin
    (Code_Gen_Model_B.BR_Steer_Module_Angle);
  ...
  rtb_Subtract_hf = cos(Code_Gen_Model_B.Gyro_Angle_Field_rad);
  ...
  rtb_Rotationmatrixfromlocalto_3 = rtb_Subtract_hf;
   ...
   *  Store in Global RAM
   */
  rtb_Subtract_hf = Code_Gen_Model_B.Gyro_Angle_Field_rad -
   ...
   *  Math: '<S21>/Square'
   */
  rtb_Switch2_g = 1.0 - ((rtb_Subtract_hf * rtb_Subtract_hf) *
    0.16666666666666666);
   ...
   */
  rtb_Switch2_ji = (rtb_Switch2_g * tmp[0]) + ((-rtb_Subtract_hf) * tmp[1]);
  rtb_Abs1 = (rtb_Subtract_hf * tmp[0]) + (rtb_Switch2_g * tmp[1]);

  /* Product: '<S21>/Product6' incorporates:
   *  Concatenate: '<S21>/Rotation matrix from local to global'
   */
  Code_Gen_Model_B.Product6[0] = (rtb_Rotationmatrixfromlocalto_0 *
    rtb_Switch2_ji) + (rtb_Rotationmatrixfromlocalto_2 * rtb_Abs1);
  Code_Gen_Model_B.Product6[1] = (rtb_Rotationmatrixfromlocalto_1 *
    rtb_Switch2_ji) + (rtb_Rotationmatrixfromlocalto_3 * rtb_Abs1);
  ...
  if ((Code_Gen_Model_U.Num_Tags_Detected > 0.0) && (KF_Enable != 0.0)) {
    ...
    rtb_Rotationmatrixfromlocalto_2 = rtb_Reshapey[0] - (rtb_Switch2_ji +
      rtb_Abs1);
     ...
     *  Sum: '<S191>/Add1'
     */
    rtb_Switch2_ji = rtb_Reshapey[1] - (rtb_Switch2_ji + rtb_Abs1);
    ...
    Code_Gen_Model_B.Product3[1] = (1.304610855474728E-16 *
      rtb_Rotationmatrixfromlocalto_2) + (0.095124921972504 * rtb_Switch2_ji);
  ...
  Code_Gen_Model_Debounce((Code_Gen_Model_U.Elevator_Limit_Switch_Bottom != 0.0),
    ...
    &Code_Gen_Model_B.Out_m, &Code_Gen_Model_DW.sf_Debounce);
  ...
  switch (rtAction) {
   case 0:
     ...
     */
    Code_Gen_Model_Y.Enable_Wheels = 0.0;
   ...
   case 1:
    if (rtAction != rtPrevAction) {
      ...
      Code_Gen_Model_B.Align_Left_e = false;
      Code_Gen_Model_B.Align_Right_o = false;
      Code_Gen_Model_B.Align_Center_c = false;
      Code_Gen_Model_B.Gamepad_B4_Y_out = false;
      Code_Gen_Model_B.Gamepad_Start_out = false;
      Code_Gen_Model_B.Gamepad_Back_out = false;
      Code_Gen_Model_B.Gamepad_LT_out = false;
      Code_Gen_Model_B.Gamepad_POV_Down_f = false;
      Code_Gen_Model_B.Gamepad_POV_Left_f = false;
      Code_Gen_Model_B.Spline_Enable = false;
      ...
      Code_Gen_Model_DW.is_c6_Code_Gen_Model = Code_Gen_M_IN_NO_ACTIVE_CHILD_b;
      Code_Gen_Model_DW.is_Center = Code_Gen_M_IN_NO_ACTIVE_CHILD_b;
      Code_Gen_Model_DW.is_Path_to_Reef = Code_Gen_M_IN_NO_ACTIVE_CHILD_b;
      Code_Gen_Model_DW.is_Left_and_Right = Code_Gen_M_IN_NO_ACTIVE_CHILD_b;
      Code_Gen_Model_DW.is_Path_to_Reef_1 = Code_Gen_M_IN_NO_ACTIVE_CHILD_b;
      Code_Gen_Model_DW.is_Path_to_Reef_2 = Code_Gen_M_IN_NO_ACTIVE_CHILD_b;
      Code_Gen_Model_DW.is_Path_to_Reef_3 = Code_Gen_M_IN_NO_ACTIVE_CHILD_b;
      ...
      Code_Gen__Reefscape_Chart_Reset(&Code_Gen_Model_B.State_ID_Auto,
        ...
        &Code_Gen_Model_B.Coral_Wheel_DC_e,
        ...
        &Code_Gen_Model_B.Coral_Pickup_Lower_Wait_State_o,
        &Code_Gen_Model_B.Set_Coral_Level_j, &Code_Gen_Model_B.Set_Algae_Level_n,
        &Code_Gen_Model_B.Coral_Score_l, &Code_Gen_Model_DW.sf_Reefscape_Chart);
      ...
      switch (Code_Gen_Model_DW.is_Center) {
       case Code_IN_Adjust_Height_for_Algae:
        ...
        if (Code_Gen_Model_DW.timer >= Auto_Algae_Height_Time) {
          ...
          Code_Gen_Model_B.Align_Center_c = true;
          Code_Gen_Model_DW.timer = 0.0;
        } else {
          Code_Gen_Model_DW.timer += 0.02;
        }
       ...
       case IN_Back_Up_from_Reef_Coral_Scor:
        ...
        if (Code_Gen_Model_DW.timer >= Auto_Backup_Time_Reef) {
          ...
          Code_Gen_Model_B.Translation_Speed_g = 0.0;
          Code_Gen_Model_B.Translation_Angle_n = 0.0;
          Code_Gen_Model_B.Gamepad_POV_Left_f = true;
          Code_Gen_Model_DW.timer = 0.0;
        } else {
          Code_Gen_Model_DW.timer += 0.02;
        }
       ...
       case IN_Back_Up_from_Reef_Coral_Sc_h:
       ...
       case IN_Drive_Backward_from_Collect_:
        ...
        if (Code_Gen_Model_DW.timer >= Auto_Backup_Time_Reef) {
          ...
          Code_Gen_Model_B.Gamepad_POV_Down_f = true;
        } else {
          Code_Gen_Model_DW.timer += 0.02;
        }
        break;
       ...
       case Code_Gen_Model_IN_Score_at_Reef:
        ...
        if (Code_Gen_Model_B.UnitDelay1) {
          Code_Gen_Model_B.Align_Left_e = false;
          Code_Gen_Model_DW.is_Center = IN_Back_Up_from_Reef_Coral_Sc_h;
          Code_Gen_Model_B.Auto_Step_ID = 123U;
          Code_Gen_Model_DW.timer = 0.0;
        }
        break;
    ...
    Code_Gen_Model_Reefscape_Chart(1, false, false, false, (((int32_T)
      ...
      Code_Gen_Model_B.Gamepad_POV_Down_f) > ((int32_T)
      Code_Gen_Model_DW.DelayInput1_DSTATE_b3)), (((int32_T)
      Code_Gen_Model_B.Gamepad_POV_Left_f) > ((int32_T)
      Code_Gen_Model_DW.DelayInput1_DSTATE_ae)), false,
     ...
     */
    if ((Code_Gen_Model_B.Align_Center_c) && (Code_Gen_Model_B.Set_Coral_Level_j
         == 1)) {
      rtb_Switch2_ji = AT_Reef_Target_L1_X;
    } else {
      /* Logic: '<S29>/OR' */
      Robot_Reached_Destination = ((Code_Gen_Model_B.Align_Left_e) ||
        (Code_Gen_Model_B.Align_Right_o));
    ...
    Robot_Reached_Destination =
      (((((!(Code_Gen_Model_B.Limelight_Tag_Corrected_X == 0.0)) ||
        ...
        ((Code_Gen_Model_B.Set_Coral_Level_j != 0) ||
         (Code_Gen_Model_B.Set_Algae_Level_n != 0))) &&
       (((Code_Gen_Model_B.Align_Left_e) || (Code_Gen_Model_B.Align_Right_o)) ||
        (Code_Gen_Model_B.Align_Center_c)));
    ...
    if (Code_Gen_Model_B.Auto_AT_Relative_Enable) {
      ...
      /* Merge: '<S20>/Merge3' */
      Code_Gen_Model_B.Translation_Angle = Code_Gen_Model_B.Translation_Angle_n;
    ...
    Code_Gen_Model_DW.DelayInput1_DSTATE_b3 =
      Code_Gen_Model_B.Gamepad_POV_Down_f;
    ...
    Code_Gen_Model_DW.DelayInput1_DSTATE_ae =
      Code_Gen_Model_B.Gamepad_POV_Left_f;
   ...
   case 2:
     ...
     *  Inport: '<Root>/IsBlueAlliance'
     */
    rtb_Compare_m3 = ((Code_Gen_Model_B.Cage_Left_Start) &&
                      (Code_Gen_Model_U.IsBlueAlliance != 0.0));

    /* Logic: '<S421>/Logical Operator10' incorporates:
     *  Inport: '<Root>/IsBlueAlliance'
     */
    rtb_Is_Absolute_Steering = !(Code_Gen_Model_U.IsBlueAlliance != 0.0);

    /* Logic: '<S421>/Logical Operator9' */
    rtb_Is_Absolute_Translation_g = ((Code_Gen_Model_B.Cage_Left_Start) &&
      rtb_Is_Absolute_Steering);

    /* Logic: '<S421>/Logical Operator7' incorporates:
     *  Inport: '<Root>/IsBlueAlliance'
     */
    rtb_Swerve_Motors_Disabled = ((Code_Gen_Model_B.Cage_Middle_Start) &&
      (Code_Gen_Model_U.IsBlueAlliance != 0.0));
     ...
     *  Inport: '<Root>/IsBlueAlliance'
     */
    rtb_Is_Absolute_Steering = ((Code_Gen_Model_B.Coral_Station_Left) &&
      (Code_Gen_Model_U.IsBlueAlliance != 0.0));
    ...
    if (rtb_Is_Absolute_Steering) {
      ...
      /* Switch: '<S421>/Switch34' incorporates:
      ...
      /* Switch: '<S421>/Switch39' incorporates:
      ...
      /* Switch: '<S421>/Switch35' incorporates:
      ...
      /* Switch: '<S421>/Switch40' incorporates:
     ...
     */
    Compare_f = ((rtb_DeadZone != 0.0) && Robot_Reached_Destination);
    ...
    /* Sum: '<S422>/Subtract1' */
    rtb_Rotationmatrixfromlocalto_0 = rtb_Switch2_ji -
      Code_Gen_Model_B.Limelight_Tag_Corrected_Y;

    /* SignalConversion: '<S26>/Signal Copy8' */
    Code_Gen_Model_B.AT_Relative_Error_Error_Y = rtb_Rotationmatrixfromlocalto_0;
    ...
    if (Code_Gen_Model_DW.FixPtUnitDelay2_DSTATE_a != 0) {
      rtb_Rotationmatrixfromlocalto_1 = rtb_UnitDelay3;
    } else {
    ...
    if (Compare) {
       ...
       *  Switch: '<S445>/Switch2'
       */
      rtb_Minus_k_idx_0 = rtb_Modulation_Drv * rtb_Rotationmatrixfromlocalto_3;
     ...
     *  UnaryMinus: '<S422>/Unary Minus1'
     */
    rtb_Rotationmatrixfromlocalto_1 = fabs(-rtb_Subtract_hf);

    /* Abs: '<S422>/Abs1' */
    rtb_Rotationmatrixfromlocalto_0 = fabs(rtb_Rotationmatrixfromlocalto_0);
    ...
    Code_Gen_Model_B.Teleop_AT_On_Target = (((Coral_Score &&
      (rtb_Rotationmatrixfromlocalto_1 <= AT_Max_Error_XY)) &&
      (rtb_Rotationmatrixfromlocalto_0 <= AT_Max_Error_XY)) && (rtb_UnitDelay3 <=
      AT_Max_Error_Angle));
    ...
    Code_Gen_Model_B.Swerve_Drive_Integral_Enable = (((Coral_Score &&
      ...
      (rtb_Rotationmatrixfromlocalto_0 <= AT_Integral_Enable_Error_XY)) &&
    ...
    if (Code_Gen_Model_B.AT_Relative_Error_Enable) {
       ...
       */
      rtb_Rotationmatrixfromlocalto_1 = Code_Gen_Model_B.AT_Relative_Error_Angle
        * AT_Steering_Error_Angle_Gain_P;
       ...
       */
      if (rtb_Rotationmatrixfromlocalto_1 > AT_Steering_Speed_Max) {
        rtb_Rotationmatrixfromlocalto_1 = AT_Steering_Speed_Max;
      } else if (rtb_Rotationmatrixfromlocalto_1 < (-AT_Steering_Speed_Max)) {
     ...
     */
    Compare_f = (rtb_Rotationmatrixfromlocalto_1 == 0.0);
    ...
    if (Code_Gen_Model_B.Face_Away_Driver) {
       ...
       *  Switch: '<S444>/Switch7'
       */
      rtb_Rotationmatrixfromlocalto_0 = Code_Gen_Model_B.AT_Field_Target_Angle;
    } else {
      /* Switch: '<S444>/Switch6' incorporates:
       *  Switch: '<S444>/Switch5'
       *  Switch: '<S444>/Switch7'
    ...
    if (Code_Gen_Model_B.Steering_Abs_Angle_Active) {
      /* Switch: '<S444>/Switch3' */
      Code_Gen_Model_B.Steering_Abs_Angle = rtb_Rotationmatrixfromlocalto_0;
    } else {
  ...
  if (rtAction == 0) {
    ...
    if (rtAction == 0) {
       ...
       */
      rtb_Switch2_g = rtb_Ref_Poses[((int32_T)
       ...
       *  Selector: '<S215>/Selector'
       */
      rtb_Minus_n[0] = rtb_Reshapey[0] - rtb_Switch2_g;
       ...
       *  Sum: '<S215>/Minus'
       */
      rtb_Minus_k_idx_0 = rtb_Ref_Poses[((int32_T)
       ...
       *  Selector: '<S215>/Selector'
       */
      rtb_Minus_n[1] = rtb_Reshapey[1] - rtb_Minus_k_idx_0;
      ...
      switch (rtAction) {
       case 0:
        ...
        if (rtAction == 0) {
          ...
          rtb_AT_Cage_Middle_Start_Red_Ac =
            ((Code_Gen_Model_DW.UnitDelay_DSTATE_n) || (rtb_Abs1 <=
              Spline_Stop_Radius));
          ...
          Code_Gen_Model_DW.UnitDelay_DSTATE_n = rtb_AT_Cage_Middle_Start_Red_Ac;
       ...
       case 1:
         ...
         *  Selector: '<S208>/Selector1'
         */
        rtb_Rotationmatrixfromlocalto_1 = rtb_Ref_Poses[((int32_T)rtb_Abs1) - 1];

        /* Sum: '<S226>/Subtract' incorporates:
         *  Selector: '<S218>/Selector1'
         *  Sum: '<S226>/Minus1'
         */
        rtb_Minus_n[0] = rtb_Rotationmatrixfromlocalto_1 - rtb_Switch2_g;

        /* Selector: '<S218>/Selector1' incorporates:
         *  Selector: '<S208>/Selector1'
         */
        rtb_Subtract_d4 = rtb_Ref_Poses[((int32_T)rtb_Abs1) + 9];

        /* Sum: '<S226>/Subtract' incorporates:
         *  Selector: '<S218>/Selector1'
         *  Sum: '<S226>/Minus1'
         */
        rtb_Minus_n[1] = rtb_Subtract_d4 - rtb_Minus_k_idx_0;
        ...
        rtb_Minus_n[1] = ((-rtb_Rotationmatrixfromlocalto_3) / rtb_Switch2_ji) *
          rtb_Rotationmatrixfromlocalto_2;
         ...
         *  Sum: '<S226>/Minus'
         */
        rtb_Rotationmatrixfromlocalto_1 = (rtb_Rotationmatrixfromlocalto_1 +
         ...
         *  Sum: '<S226>/Minus'
         */
        rtb_Subtract_hf = rtb_Reshapey[0] - rtb_Rotationmatrixfromlocalto_3;

        /* Sum: '<S226>/Add' incorporates:
         *  Sum: '<S226>/Add2'
         *  Sum: '<S226>/Minus1'
         */
        rtb_Abs1 = rtb_Switch2_g - rtb_Minus_n[0];

        /* Sum: '<S226>/Minus' incorporates:
         *  Sum: '<S226>/Minus1'
         */
        rtb_Rotationmatrixfromlocalto_3 -= rtb_Abs1;
         ...
         *  Sum: '<S226>/Minus5'
         */
        rtb_Switch2_ji = (rtb_Reshapey[0] - rtb_Abs1) *
          rtb_Rotationmatrixfromlocalto_3;

        /* DotProduct: '<S226>/Dot Product1' incorporates:
         *  Sum: '<S226>/Minus'
         */
        rtb_Switch2_g = rtb_Rotationmatrixfromlocalto_3 *
          rtb_Rotationmatrixfromlocalto_3;
         ...
         *  Sum: '<S226>/Minus4'
         */
        rtb_Init = rtb_Rotationmatrixfromlocalto_1 *
          rtb_Rotationmatrixfromlocalto_1;
         ...
         *  Sum: '<S226>/Minus'
         */
        rtb_Rotationmatrixfromlocalto_3 = rtb_Subtract_d4 - rtb_Minus_n[1];

        /* Sum: '<S226>/Minus4' incorporates:
         *  Sum: '<S226>/Add2'
         *  Sum: '<S226>/Minus'
         */
        rtb_Rotationmatrixfromlocalto_1 = (rtb_Subtract_d4 + rtb_Minus_n[1]) -
          rtb_Rotationmatrixfromlocalto_3;
         ...
         *  Sum: '<S226>/Minus'
         */
        rtb_Subtract_hf = rtb_Reshapey[1] - rtb_Rotationmatrixfromlocalto_3;

        /* Sum: '<S226>/Add' incorporates:
         *  Sum: '<S226>/Add2'
         *  Sum: '<S226>/Minus1'
         */
        rtb_Abs1 = rtb_Minus_k_idx_0 - rtb_Minus_n[1];
         ...
         *  Sum: '<S226>/Minus5'
         */
        rtb_Switch2_ji += (rtb_Reshapey[1] - rtb_Abs1) *
          rtb_Rotationmatrixfromlocalto_3;
         ...
         *  Sum: '<S226>/Minus'
         */
        rtb_Swerve_Motors_Disabled = (rtb_Switch2_ji <=
         ...
         *  Sum: '<S226>/Minus5'
         */
        rtb_Switch2_ji = (rtb_Rotationmatrixfromlocalto_1 * rtb_Subtract_hf) +
        ...
        Code_Gen_Model_B.Spline_Follow_Index = ((real_T)
          (((rtb_Is_Absolute_Translation_g && rtb_Swerve_Motors_Disabled) &&
            (rtb_Switch2_ji >= 0.0)) && (rtb_Switch2_ji <=
          ((rtb_Rotationmatrixfromlocalto_1 * rtb_Rotationmatrixfromlocalto_1) +
    ...
    if (!rtb_Swerve_Motors_Disabled) {
      ...
      do {
        ...
        rtb_Subtract_hf = rtb_Assignment[s234_iter + 12];
        rtb_Add2_f[1] = rtb_Subtract_hf - rtb_Assignment[s234_iter + 14];
        rtb_uDLookupTable_l = rtb_Rotationmatrixfromlocalto_1 - rtb_Subtract_hf;
        for (rtb_Bias1_p = 0; rtb_Bias1_p < 50; rtb_Bias1_p++) {
          ...
          rtb_Modulation_Drv = (((rtb_Minus_n[1] *
            rtb_Rotationmatrixfromlocalto_3) + (rtb_Add2_f[1] *
            rtb_Rotationmatrixfromlocalto_1)) * 0.0) + (rtb_uDLookupTable_l *
            rtb_Subtract_d4);
          ...
          rtb_Rotationmatrixfromlocalto_3 = (((rtb_Minus_n[1] * rtb_Subtract_d4)
            ...
            (rtb_uDLookupTable_l * rtb_Switch2_ji);
          rtb_Subtract_d4 = rt_powd_snf(rt_hypotd_snf
            (rtb_Rotationmatrixfromlocalto_0, rtb_Modulation_Drv), 3.0);
          ...
          rtb_Assignment_d[rtb_Bias1_p + 100] = fabs
            ((rtb_Rotationmatrixfromlocalto_0 * rtb_Rotationmatrixfromlocalto_3)
             - (rtb_Rotationmatrixfromlocalto_1 * rtb_Modulation_Drv)) /
    ...
    s259_iter = 1U;
    rtb_Is_Absolute_Steering = true;
    while (rtb_Is_Absolute_Steering && (s259_iter <= 150)) {
      /* Outputs for Iterator SubSystem: '<S209>/Find first index that meets distance target' incorporates:
       *  WhileIterator: '<S259>/While Iterator'
       */
      ...
      rtb_Is_Absolute_Steering =
        ((rtb_Assignment_d[Code_Gen_Model_B.WhileIterator - 1] <=
          (rtb_Assignment_d[s234_iter - 1] + rtb_Rotationmatrixfromlocalto_2)) &&
   ...
   *  Fcn: '<S418>/theta->y'
   */
  rtb_Subtract_hf = Code_Gen_Model_B.Translation_Speed_RL * sin
    (Code_Gen_Model_B.Translation_Steering_Cmd);
  ...
  rtb_Reshapey[1] = (Code_Gen_Model_B.Steering_Localized_Cmd * sin
                     (Code_Gen_Model_ConstB.FL_Tangent_Angle)) + rtb_Subtract_hf;
  ...
  rtb_Minus_n[1] = (Code_Gen_Model_B.Steering_Localized_Cmd * sin
                    (Code_Gen_Model_ConstB.FR_Tangent_Angle)) + rtb_Subtract_hf;
  ...
  rtb_Add2_f[1] = (Code_Gen_Model_B.Steering_Localized_Cmd * sin
                   (Code_Gen_Model_ConstB.BL_Tangent_Angle)) + rtb_Subtract_hf;
  ...
  rtb_Minus_k_idx_0 = (Code_Gen_Model_B.Steering_Localized_Cmd * cos
    ...
    rtb_Rotationmatrixfromlocalto_1;
  rtb_uDLookupTable_l = (Code_Gen_Model_B.Steering_Localized_Cmd * sin
    (Code_Gen_Model_ConstB.BR_Tangent_Angle)) + rtb_Subtract_hf;

  /* Fcn: '<S417>/x->r' */
  rtb_Subtract_hf = rt_hypotd_snf(rtb_Minus_k_idx_0, rtb_uDLookupTable_l);

  /* RelationalOperator: '<S420>/Compare' incorporates:
   *  Constant: '<S420>/Constant'
   */
  rtb_Is_Absolute_Steering = (rtb_Subtract_hf == 0.0);
  ...
  if (rtb_Is_Absolute_Steering) {
    ...
    /* Switch: '<S416>/Switch1' */
    Code_Gen_Model_B.BR_Desired_Wheel_Speed_in = rtb_Subtract_hf;
  }

  /* End of Switch: '<S416>/Switch1' */

  /* Fcn: '<S402>/x->r' */
  rtb_Subtract_hf = rt_hypotd_snf(rtb_Reshapey[0], rtb_Reshapey[1]);

  /* RelationalOperator: '<S405>/Compare' incorporates:
   *  Constant: '<S405>/Constant'
   */
  rtb_Is_Absolute_Translation_g = (rtb_Subtract_hf == 0.0);
  ...
  if (rtb_Is_Absolute_Translation_g) {
    ...
    /* Switch: '<S401>/Switch1' */
    Code_Gen_Model_B.FL_Desired_Wheel_Speed_in = rtb_Subtract_hf;
  }
   ...
   */
  rtb_AT_Cage_Middle_Start_Red_Ac = (rtb_Init == 0.0);
   ...
   *  MinMax: '<S396>/Max'
   */
  rtb_Subtract_hf = 5.1198378053698752 / fmax(fmax(fmax(fmax(5.1198378053698752,
  ...
  if (!rtb_Is_Absolute_Steering) {
     ...
     *  Fcn: '<S417>/x->theta'
     */
    Code_Gen_Model_B.BR_Desired_Module_Angle = rt_atan2d_snf(rtb_uDLookupTable_l,
      rtb_Minus_k_idx_0);
  }
  ...
  /* Math: '<S352>/Hypot' */
  rtb_Modulation_Drv = rt_hypotd_snf(rtb_Rotationmatrixfromlocalto_0,
    rtb_Rotationmatrixfromlocalto_1);
  ...
  if (rtb_Modulation_Drv > 1.0E-6) {
    rtb_Switch2_g = rtb_Rotationmatrixfromlocalto_1 / rtb_Modulation_Drv;
    rtb_Init = rtb_Rotationmatrixfromlocalto_0 / rtb_Modulation_Drv;
  } else {
    rtb_Switch2_g = 0.0;
    rtb_Init = 1.0;
  }
  ...
  if (Code_Gen_Model_B.Swerve_Drive_Integral_Enable) {
     ...
     */
    rtb_DeadZone = 1.0 - rtb_Modulation_Drv;
     ...
     *  Sum: '<S340>/Subtract'
     */
    if (!(rtb_Rotationmatrixfromlocalto_0 > (1.0 - rtb_Modulation_Drv))) {
    ...
    if (rtb_DeadZone > Drive_Motor_Control_I_UL) {
      rtb_Rotationmatrixfromlocalto_0 = Drive_Motor_Control_I_UL;
    } else if (rtb_DeadZone < Drive_Motor_Control_I_LL) {
      rtb_Rotationmatrixfromlocalto_0 = Drive_Motor_Control_I_LL;
    } else {
      rtb_Rotationmatrixfromlocalto_0 = rtb_DeadZone;
    }
  ...
  /* Sum: '<S340>/Add1' */
  rtb_Minus_k_idx_0 = rtb_Modulation_Drv + rtb_Rotationmatrixfromlocalto_0;
   ...
   */
  rtb_Modulation_Drv = (rtb_Subtract_fc * rtb_uDLookupTable_l) +
   ...
   *  Trigonometry: '<S289>/Sin4'
   */
  rtb_DeadZone = (rtb_Subtract_fc * rtb_Init) - (rtb_Integral_hv *
    rtb_uDLookupTable_l);

  /* Math: '<S289>/Hypot' */
  rtb_UnitDelay3 = rt_hypotd_snf(rtb_DeadZone, rtb_Modulation_Drv);
   ...
   *  Switch: '<S289>/Switch1'
   */
  if (rtb_UnitDelay3 > 1.0E-6) {
    rtb_Switch2_g = rtb_Modulation_Drv / rtb_UnitDelay3;
    rtb_Init = rtb_DeadZone / rtb_UnitDelay3;
  } else {
    rtb_Switch2_g = 0.0;
    rtb_Init = 1.0;
  }
  ...
  if (fabs(rt_atan2d_snf(rtb_Switch2_g, rtb_Init)) > 1.5707963267948966) {
     ...
     *  UnaryMinus: '<S278>/Unary Minus'
     */
    rtb_Modulation_Drv = (rtb_Subtract_fc * Code_Gen_Model_ConstB.Sin5) +
     ...
     */
    rtb_UnitDelay3 = (rtb_Subtract_fc * Code_Gen_Model_ConstB.Cos5) -
      (rtb_Integral_hv * Code_Gen_Model_ConstB.Sin5);

    /* Math: '<S288>/Hypot' */
    rtb_DeadZone = rt_hypotd_snf(rtb_UnitDelay3, rtb_Modulation_Drv);
    ...
    if (rtb_DeadZone > 1.0E-6) {
      rtb_UnitDelay3 /= rtb_DeadZone;
      rtb_Modulation_Drv /= rtb_DeadZone;
    } else {
      rtb_UnitDelay3 = 1.0;
    ...
    rtb_uDLookupTable_l = rt_atan2d_snf(rtb_Modulation_Drv, rtb_UnitDelay3);
  } else {
    rtb_Minus_k_idx_0 = Code_Gen_Model_B.FL_Desired_Wheel_Speed;
   ...
   *  Inport: '<Root>/FrontLeft_Drive_Motor_Speed'
   */
  rtb_UnitDelay3 = rtb_Switch2_g - Code_Gen_Model_U.FrontLeft_Drive_Motor_Speed;
   ...
   */
  rtb_Modulation_Drv = ((rtb_UnitDelay3 - Code_Gen_Model_DW.UnitDelay1_DSTATE_f)
   ...
   */
  rtb_DeadZone = rtb_Modulation_Drv * Drive_Motor_Control_D;
   ...
   *  Store in Global RAM
   */
  rtb_Minus_k_idx_0 = rtb_DeadZone - Code_Gen_Model_DW.UD_DSTATE_h;
  ...
  rtb_Add_ju = ((Drive_Motor_Control_FF * rtb_Switch2_g) +
                (Drive_Motor_Control_P * rtb_UnitDelay3)) + rtb_Minus_k_idx_0;
  ...
  if (Code_Gen_Model_B.Swerve_Drive_Integral_Enable) {
     ...
     */
    rtb_UnitDelay3 = (Drive_Motor_Control_I * rtb_UnitDelay3) +
     ...
     *  Sum: '<S277>/Subtract'
     */
    if (!(rtb_UnitDelay3 > (1.0 - rtb_Add_ju))) {
    ...
    if (rtb_Switch2_pt > Drive_Motor_Control_I_UL) {
      rtb_UnitDelay3 = Drive_Motor_Control_I_UL;
    } else if (rtb_Switch2_pt < Drive_Motor_Control_I_LL) {
      rtb_UnitDelay3 = Drive_Motor_Control_I_LL;
    } else {
      rtb_UnitDelay3 = rtb_Switch2_pt;
    }
  ...
  /* Sum: '<S277>/Add1' */
  rtb_Minus_k_idx_0 = rtb_Add_ju + rtb_UnitDelay3;
   ...
   *  Sum: '<S293>/Add2'
   */
  rtb_Switch2_g = rt_modd_snf(rtb_uDLookupTable_l + 3.1415926535897931,
  ...
  if (rtb_Hypot_bl > 1.0E-6) {
    rtb_Switch2_g = rtb_Add_fn / rtb_Hypot_bl;
    rtb_Init = rtb_Subtract1_la / rtb_Hypot_bl;
  } else {
    rtb_Switch2_g = 0.0;
    rtb_Init = 1.0;
  }
  ...
  Code_Gen_Model_B.FR_Desired_Wheel_Speed =
    Code_Gen_Model_B.FR_Desired_Wheel_Speed_in * rtb_Subtract_hf;
  ...
  if (fabs(rt_atan2d_snf(rtb_Switch2_g, rtb_Init)) > 1.5707963267948966) {
     ...
     */
    rtb_Hypot_bl = (rtb_Subtract_fc * Code_Gen_Model_ConstB.Cos5_g) -
   ...
   *  Inport: '<Root>/FrontRight_Drive_Motor_Speed'
   */
  rtb_Hypot_bl = rtb_Switch2_g - Code_Gen_Model_U.FrontRight_Drive_Motor_Speed;
  ...
  /* Sum: '<S298>/Add1' */
  rtb_Minus_k_idx_0 = rtb_Add_c + rtb_Hypot_bl;
  ...
  Code_Gen_Model_B.BL_Desired_Wheel_Speed =
    Code_Gen_Model_B.BL_Desired_Wheel_Speed_in * rtb_Subtract_hf;
   ...
   */
  rtb_Subtract_hf = rtb_Minus_k_idx_0 * 1210.9758620668042;

  /* Signum: '<S318>/Sign' */
  if (rtIsNaN(rtb_Subtract_hf)) {
    rtb_Minus_k_idx_0 = (rtNaN);
  } else if (rtb_Subtract_hf < 0.0) {
    rtb_Minus_k_idx_0 = -1.0;
  } else {
    rtb_Minus_k_idx_0 = (rtb_Subtract_hf > 0.0);
  }
   ...
   *  Sum: '<S334>/Add2'
   */
  rtb_Subtract_hf = (((real_T)((rtb_Minus_k_idx_0 == rtb_Switch2_pb) || (fabs
    (Code_Gen_Model_U.BackLeft_Drive_Motor_Speed) <=
    Drive_Motor_Control_Sign_Change_Deadband))) * rtb_Subtract_hf) *
   ...
   *  Inport: '<Root>/BackLeft_Drive_Motor_Speed'
   */
  rtb_Switch2_g = rtb_Subtract_hf - Code_Gen_Model_U.BackLeft_Drive_Motor_Speed;
   ...
   *  Saturate: '<S319>/Saturation'
   */
  rtb_Subtract_hf = ((Drive_Motor_Control_FF * rtb_Subtract_hf) +
                     (Drive_Motor_Control_P * rtb_Switch2_g)) +
    rtb_Minus_k_idx_0;
  ...
  if (Code_Gen_Model_B.Swerve_Drive_Integral_Enable) {
     ...
     */
    rtb_Integral_hv = 1.0 - rtb_Subtract_hf;
     ...
     *  Sum: '<S319>/Subtract'
     */
    if (!(rtb_Switch2_g > (1.0 - rtb_Subtract_hf))) {
  ...
  /* Sum: '<S319>/Add1' */
  rtb_Minus_k_idx_0 = rtb_Subtract_hf + rtb_Integral_hv;
   ...
   *  Sum: '<S335>/Add2'
   */
  rtb_Subtract_hf = rt_modd_snf(rtb_Init + 3.1415926535897931,
    6.2831853071795862) - 3.1415926535897931;
   ...
   */
  rtb_Sum1_m = ((rtb_Subtract_hf - Code_Gen_Model_DW.UnitDelay1_DSTATE_nw) *
                Steering_Motor_Control_D_FilterCoeff) +
   ...
   *  Saturate: '<S322>/Saturation'
   */
  rtb_Init = (Steering_Motor_Control_P * rtb_Subtract_hf) + rtb_Minus_k_idx_0;
   ...
   */
  rtb_Subtract_hf = (Steering_Motor_Control_I * rtb_Subtract_hf) +
   ...
   *  Sum: '<S322>/Subtract'
   */
  if (!(rtb_Subtract_hf > (1.0 - rtb_Init))) {
   ...
   *  Sum: '<S356>/Add2'
   */
  rtb_Subtract_hf = rt_modd_snf(rtb_Optimized_Module_Angle + 3.1415926535897931,
    6.2831853071795862) - 3.1415926535897931;
   ...
   */
  rtb_Optimized_Module_Angle = ((rtb_Subtract_hf -
   ...
   *  Merge: '<S20>/Merge13'
   */
  rtb_Subtract_hf = fmax(fmax(Code_Gen_Model_B.Elevator_Height_Desired_merge,
   ...
   */
  if ((Code_Gen_Model_B.Elevator_Height_Desired_merge < rtb_Subtract_hf) &&
      (fabs(Code_Gen_Model_B.Elevator_Error) <= Elevator_Height_Error_Threshold))
  {
   ...
   *  Switch: '<S12>/Switch3'
   */
  Code_Gen_Model_B.Elevator_Error = (rtb_Subtract_hf -
   ...
   *  Logic: '<S12>/OR'
   */
  rtb_Is_Absolute_Steering = (((!rtb_Compare_m3) &&
  ...
  if (rtb_Is_Absolute_Steering) {
    ...
    if (!Code_Gen_Model_DW.DelayInput1_DSTATE_be) {
       ...
       */
      rtb_Subtract_hf = (Elevator_Gain_Int * Code_Gen_Model_B.Elevator_Error) +
       ...
       */
      if (!(rtb_Subtract_hf > rtb_Switch2_g)) {
  ...
  if (Code_Gen_Model_B.Reefscape_Motors_Enable_merge) {
    ...
    if (rtb_Compare_m3) {
      ...
      {
        rtb_Subtract_hf = Elevator_Bottom_DC;
      } else {
        rtb_Subtract_hf = Elevator_Total_LL;
      }
      ...
      if (Code_Gen_Model_B.Out) {
        rtb_Subtract_hf = Elevator_Hold_at_Top_DC;
      } else {
        rtb_Subtract_hf = 1.0;
      }
       ...
       */
      if (!(rtb_Switch2_g > rtb_Subtract_hf)) {
   ...
   *  Sum: '<S92>/Subtract'
   */
  rtb_Init = fabs(rtb_Switch2_g - rtb_Subtract_hf);
  ...
  if (rtIsNaN(rtb_Subtract_hf)) {
    ...
    rtb_Switch2_pb = (rtb_Subtract_hf > 0.0);
  }
   ...
   */
  rtb_Compare_m3 = (rtb_Subtract_hf == 0.0);
  ...
  if (Code_Gen_Model_B.Coral_Arm_Angle_Desired_merge > 90.0) {
    rtb_Subtract_hf = 90.0;
  } else {
    /* Lookup_n-D: '<S8>/Range of Motion Protection Limit' incorporates:
     *  Switch: '<S13>/Switch'
     */
    rtb_Subtract_hf = look1_binlcpw(Code_Gen_Model_B.Elevator_Height_Measured,
     ...
     */
    if (!(Code_Gen_Model_B.Coral_Arm_Angle_Desired_merge < rtb_Subtract_hf)) {
      rtb_Subtract_hf = Code_Gen_Model_B.Coral_Arm_Angle_Desired_merge;
    }
  ...
  /* Sum: '<S8>/Subtract' */
  Code_Gen_Model_B.Coral_ArmAngle_Error = rtb_Subtract_hf -
    Code_Gen_Model_B.Coral_Arm_Angle_Measured;
   ...
   *  Bias: '<S1>/Add Constant'
   */
  rtb_Subtract_hf = look1_binlcpw(Code_Gen_Model_B.Coral_Arm_Angle_Measured,
  ...
  if (rtb_Is_Absolute_Translation_g) {
    ...
    if (!Code_Gen_Model_DW.DelayInput1_DSTATE_op) {
      ...
      if (!(rtb_Init > rtb_Switch2_pb)) {
        /* Sum: '<S75>/Subtract1' */
        rtb_Switch2_pb = rtb_Subtract_hf -
  ...
  if (Code_Gen_Model_B.Reefscape_Motors_Enable_merge) {
     ...
     */
    if (rtb_Compare_m3) {
      rtb_Subtract_hf = Coral_Arm_Neg90_DC;
    } else if (rtb_Swerve_Motors_Disabled) {
      /* Switch: '<S8>/Switch3' incorporates:
       *  Constant: '<S8>/Constant1'
       */
      rtb_Subtract_hf = Coral_Arm_Pos90_DC;
    } else {
      ...
      if (rtb_Init > rtb_Switch2_g) {
        rtb_Subtract_hf = rtb_Switch2_g;
      } else if (!(rtb_Init < rtb_Subtract_hf)) {
        rtb_Subtract_hf = rtb_Init;
      }
   ...
   */
  rtb_Swerve_Motors_Disabled = (rtb_Subtract_hf > 0.0);
  ...
  /* Sum: '<S81>/Sum' */
  rtb_Subtract_hf = rtb_Switch2_g + rtb_Init;

  /* Outport: '<Root>/Coral_Arm_DutyCycle' */
  Code_Gen_Model_Y.Coral_Arm_DutyCycle = rtb_Subtract_hf;
   ...
   */
  rtb_AT_Cage_Middle_Start_Red_Ac = (MultiportSwitch == 0);
  ...
  if (Compare && (Code_Gen_Model_B.Winch_Cmd)) {
    ...
    rtb_Swerve_Motors_Disabled = ((!rtb_AT_Cage_Middle_Start_Red_Ac) &&
  ...
  if (Compare && (Code_Gen_Model_B.Actuator_Cmd)) {
    ...
    rtb_AT_Cage_Middle_Start_Red_Ac = ((!rtb_AT_Cage_Middle_Start_Red_Ac) &&
  ...
  if (fabs(Code_Gen_Model_U.Actuator_Revs) <= Actuator_Rev_Startup_Range) {
    ...
    rtb_AT_Cage_Right_Start_Blue_Ac = ((!(Code_Gen_Model_U.Actuator_Revs >=
  ...
  rtb_Switch1_j1 = (0.0 * Code_Gen_Model_DW.MemoryX_DSTATE[1]) +
    Code_Gen_Model_DW.MemoryX_DSTATE[0];
  rtb_Minus_k_idx_0 = (0.0 * Code_Gen_Model_DW.MemoryX_DSTATE[0]) +
    Code_Gen_Model_DW.MemoryX_DSTATE[1];
  ...
  Code_Gen_Model_DW.MemoryX_DSTATE[1] = (((0.0 * Code_Gen_Model_B.Product6[0]) +
    Code_Gen_Model_B.Product6[1]) + rtb_Minus_k_idx_0) +
   ...
   *  Store in Global RAM
   */
  Code_Gen_Model_DW.DelayInput1_DSTATE_b = Code_Gen_Model_B.Out_m;
   ...
   *  Store in Global RAM
   */
  Code_Gen_Model_DW.UD_DSTATE_h = rtb_DeadZone;

  /* Update for UnitDelay: '<S277>/Unit Delay' */
  Code_Gen_Model_DW.UnitDelay_DSTATE_j = rtb_UnitDelay3;
  ...
  Code_Gen_Model_DW.UnitDelay_DSTATE_oz = rtb_Subtract_hf;
  ...
  Code_Gen_Model_DW.FixPtUnitDelay1_DSTATE_pc = rtb_Subtract_hf;

  /* Update for UnitDelay: '<S14>/Unit Delay' */
  Code_Gen_Model_DW.UnitDelay_DSTATE_gln = rtb_Swerve_Motors_Disabled;

  /* Update for UnitDelay: '<S14>/Unit Delay1' */
  Code_Gen_Model_DW.UnitDelay1_DSTATE_kb = rtb_AT_Cage_Middle_Start_Red_Ac;

  /* Update for UnitDelay: '<S14>/Unit Delay2' */
  Code_Gen_Model_DW.UnitDelay2_DSTATE = rtb_AT_Cage_Right_Start_Blue_Ac;
...
{
  {
    ...
    Code_Gen_Model_Debounce_Init(&Code_Gen_Model_B.Out_m);
    ...
    Code_Gen_M_Reefscape_Chart_Init(&Code_Gen_Model_B.State_ID_Auto,
      &Code_Gen_Model_B.Elevator_Height_Desired_o,
      &Code_Gen_Model_B.Coral_Arm_Angle_Desired_c,
      &Code_Gen_Model_B.Coral_Wheel_DC_e, &Constant, &Constant1,
      &Code_Gen_Model_B.Elevator_LowerPickup_Reset_l,
      &Code_Gen_Model_B.Coral_Pickup_Lower_Wait_State_o,
      &Code_Gen_Model_B.Set_Coral_Level_j, &Code_Gen_Model_B.Set_Algae_Level_n,
      &Code_Gen_Model_B.Coral_Score_l);
