...
typedef struct {
  ...
  uint8_T is_Algae_Pickup_High;        /* '<S29>/Reefscape_Chart' */
  uint8_T is_Algae_Pickup_Low;         /* '<S29>/Reefscape_Chart' */
  uint8_T is_Algae_Score;              /* '<S29>/Reefscape_Chart' */
  ...
  uint8_T is_Coral_Pickup_Prepare;     /* '<S29>/Reefscape_Chart' */
  uint8_T is_Set_Level;                /* '<S29>/Reefscape_Chart' */
  uint8_T is_Elevator_Height_Bottom;   /* '<S29>/Reefscape_Chart' */
  uint8_T is_Elevator_Height_Bottom_pre;/* '<S29>/Reefscape_Chart' */
  uint8_T is_End_Game_Climb;           /* '<S29>/Reefscape_Chart' */
...
typedef struct {
  ...
  real_T State_ID_Teleop;              /* '<S420>/Reefscape_Chart' */
  real_T Elevator_Height_Desired;      /* '<S420>/Reefscape_Chart' */
  real_T Coral_Arm_Angle_Desired;      /* '<S420>/Reefscape_Chart' */
  ...
  boolean_T Actuator_Cmd;              /* '<S131>/Compare' */
...
typedef struct {
  ...
  real_T UnitDelay1_DSTATE_b;          /* '<S291>/Unit Delay1' */
  ...
  boolean_T UnitDelay2_DSTATE_l;       /* '<S440>/Unit Delay2' */
  ...
  DW_Reefscape_Chart_Code_Gen_M_T sf_Reefscape_Chart_n;/* '<S420>/Reefscape_Chart' */
 ...
 * '<S52>'  : 'Code_Gen_Model/RoboRio Controls/Autonomous/Subsystem/Path ID Selection/Compare To Constant2'
 ...
 * '<S105>' : 'Code_Gen_Model/RoboRio Controls/End_Game/Compare To Constant2'
 * '<S106>' : 'Code_Gen_Model/RoboRio Controls/End_Game/Compare To Zero'
 ...
 * '<S131>' : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Zero6'
