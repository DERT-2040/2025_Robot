...
typedef struct {
  ...
  real_T Gyro_Angle_Calibrated_deg;    /* '<S12>/Subtract1' */
  real_T Gyro_Angle_rad;               /* '<S107>/Gain1' */
  real_T Gyro_Angle_Field_rad;         /* '<S12>/Add' */
  real_T Product6[2];                  /* '<S18>/Product6' */
  real_T Odom_Position_X;              /* '<S18>/Accumulator2' */
  real_T KF_Position_X;                /* '<S15>/Switch' */
  real_T Odom_Position_Y;              /* '<S18>/Accumulator' */
  real_T KF_Position_Y;                /* '<S15>/Switch1' */
  real_T Drive_Joystick_X;             /* '<S13>/Signal Copy1' */
  real_T Drive_Joystick_Y;             /* '<S13>/Signal Copy2' */
  real_T Drive_Joystick_Z;             /* '<S13>/Signal Copy3' */
  real_T Steer_Joystick_Y;             /* '<S13>/Signal Copy5' */
  real_T Steer_Joystick_Z;             /* '<S13>/Signal Copy6' */
  real_T Limelight_Tag_Corrected_X;    /* '<S16>/Add' */
  real_T Limelight_Tag_Corrected_Y;    /* '<S16>/Add1' */
  real_T Limelight_Tag_Corrected_Angle;/* '<S16>/Add2' */
  ...
  real_T Spline_Num_Poses;             /* '<S17>/Merge9' */
  real_T Steering_Abs_Cmd;             /* '<S17>/Merge1' */
  real_T Steering_Rel_Cmd;             /* '<S17>/Merge2' */
  real_T Translation_Speed;            /* '<S17>/Merge4' */
  real_T Translation_Angle;            /* '<S17>/Merge3' */
  real_T Translation_Speed_SPF;        /* '<S20>/Merge2' */
  real_T Translation_Speed_RL;         /* '<S364>/Sum' */
  real_T Translation_Angle_SPF;        /* '<S20>/Merge3' */
  real_T Gyro_Angle_SPF;               /* '<S20>/Merge8' */
  real_T Translation_Steering_Cmd;     /* '<S358>/Switch' */
  real_T Steering_Abs_Cmd_SPF;         /* '<S20>/Merge' */
  real_T Steering_Localized_PID;       /* '<S385>/Saturation2' */
  real_T Steering_Rel_Cmd_SPF;         /* '<S20>/Merge1' */
  ...
  real_T Elevator_Height_Desired;      /* '<S17>/Merge11' */
  real_T Coral_Arm_Angle_Desired;      /* '<S17>/Merge13' */
  ...
  real_T Actuator_Cmd;                 /* '<S13>/Subtract' */
  real_T Actuator_Position_Desired;    /* '<S11>/Saturation' */
  real_T Actuator_Position_Measured_Raw;/* '<S10>/Gain2' */
  real_T Actuator_Position_Offset;     /* '<S10>/Switch5' */
  real_T Actuator_Position_Measured;   /* '<S10>/Subtract3' */
  ...
  real_T State_ID;                     /* '<S17>/Merge24' */
  real_T Steer_Joystick_X;             /* '<S13>/Signal Copy4' */
  real_T AT_Field_Error_X;             /* '<S416>/Switch2' */
  real_T AT_Field_Error_Y;             /* '<S416>/Switch4' */
  real_T DeadZone;                     /* '<S419>/Dead Zone' */
  real_T DeadZone1;                    /* '<S419>/Dead Zone1' */
  ...
  real_T State_ID_a;                   /* '<S419>/Reefscape_Chart' */
  real_T Elevator_Height_Desired_m;    /* '<S419>/Reefscape_Chart' */
  real_T Coral_Arm_Angle_Desired_m;    /* '<S419>/Reefscape_Chart' */
  ...
  real_T State_ID_d;                   /* '<S29>/Reefscape_Chart' */
  ...
  uint8_T Active_GameState;            /* '<S19>/Chart' */
  ...
  boolean_T Drive_Joystick_Z_Mode;     /* '<S116>/Compare' */
  boolean_T Is_Boosting;               /* '<S126>/Compare' */
  boolean_T Face_Toward_Driver;        /* '<S114>/Compare' */
  boolean_T Face_Right_Driver;         /* '<S115>/Compare' */
  boolean_T Face_Left_Driver;          /* '<S117>/Compare' */
  boolean_T Face_Away_Driver;          /* '<S110>/Compare' */
  boolean_T Align_Left;                /* '<S124>/Compare' */
  boolean_T Align_Right;               /* '<S123>/Compare' */
  boolean_T Align_Center;              /* '<S125>/Compare' */
  boolean_T Coral_Station_Left;        /* '<S122>/Compare' */
  boolean_T Coral_Station_Right;       /* '<S121>/Compare' */
  boolean_T Processor;                 /* '<S120>/Compare' */
  boolean_T Cage_Left_Start;           /* '<S118>/Compare' */
  boolean_T Cage_Middle_Start;         /* '<S119>/Compare' */
  boolean_T Cage_Right_Start;          /* '<S127>/Compare' */
  boolean_T Cage_Left_Finish;          /* '<S128>/Compare' */
  boolean_T Cage_Middle_Finish;        /* '<S129>/Compare' */
  boolean_T Cage_Right_Finish;         /* '<S130>/Compare' */
  boolean_T Gamepad_POV_Up;            /* '<S109>/Compare' */
  boolean_T Gamepad_POV_Down;          /* '<S111>/Compare' */
  boolean_T Gamepad_POV_Left;          /* '<S113>/Compare' */
  boolean_T Gamepad_POV_Right;         /* '<S112>/Compare' */
  boolean_T Spline_Enable;             /* '<S17>/Merge7' */
  boolean_T Is_Absolute_Translation_SPF;/* '<S20>/Merge4' */
  boolean_T Is_Absolute_Steering_SPF;  /* '<S20>/Merge5' */
  boolean_T Swerve_Drive_Integral_Enable;/* '<S17>/Merge23' */
  boolean_T Reefscape_Motors_Enable;   /* '<S17>/Merge12' */
  boolean_T Winch_Cmd;                 /* '<S131>/Compare' */
  boolean_T Robot_Reached_Destination_l;/* '<S20>/Merge7' */
  boolean_T Test_Mode;                 /* '<S17>/Merge10' */
  boolean_T Elevator_LowerPickup_Reset_tp;/* '<S17>/Merge21' */
  boolean_T FixPtRelationalOperator_ne;/* '<S467>/FixPt Relational Operator' */
  boolean_T FixPtRelationalOperator_j; /* '<S462>/FixPt Relational Operator' */
  boolean_T FixPtRelationalOperator_i; /* '<S469>/FixPt Relational Operator' */
  boolean_T FixPtRelationalOperator_m; /* '<S470>/FixPt Relational Operator' */
  boolean_T FixPtRelationalOperator_ji;/* '<S463>/FixPt Relational Operator' */
  boolean_T FixPtRelationalOperator_ml;/* '<S464>/FixPt Relational Operator' */
  boolean_T AT_Relative_Error_Enable;  /* '<S23>/Signal Copy6' */
  boolean_T AT_On_Target;              /* '<S23>/Signal Copy10' */
  ...
  boolean_T UnitDelay1_d;              /* '<S25>/Unit Delay1' */
  boolean_T FixPtRelationalOperator_oi;/* '<S59>/FixPt Relational Operator' */
  boolean_T FixPtRelationalOperator_p4;/* '<S54>/FixPt Relational Operator' */
  boolean_T FixPtRelationalOperator_af;/* '<S61>/FixPt Relational Operator' */
  boolean_T FixPtRelationalOperator_oe;/* '<S62>/FixPt Relational Operator' */
  boolean_T FixPtRelationalOperator_e; /* '<S55>/FixPt Relational Operator' */
  boolean_T FixPtRelationalOperator_lp;/* '<S56>/FixPt Relational Operator' */
  ...
  boolean_T Align_Right_i;             /* '<S25>/Reefscape_Auto_Steps' */
  boolean_T Align_Center_b;            /* '<S25>/Reefscape_Auto_Steps' */
  boolean_T Gamepad_B4_Y_out;          /* '<S25>/Reefscape_Auto_Steps' */
  boolean_T Gamepad_Start_out;         /* '<S25>/Reefscape_Auto_Steps' */
  boolean_T Gamepad_LT_out;            /* '<S25>/Reefscape_Auto_Steps' */
...
typedef struct {
  ...
  real_T TappedDelay_X[2];             /* '<S15>/Tapped Delay' */
  real_T TappedDelay1_X[2];            /* '<S15>/Tapped Delay1' */
  real_T MemoryX_DSTATE[2];            /* '<S135>/MemoryX' */
  real_T DelayInput1_DSTATE;           /* '<S108>/Delay Input1' */
  real_T UnitDelay1_DSTATE;            /* '<S12>/Unit Delay1' */
  real_T UD_DSTATE_d;                  /* '<S189>/UD' */
  real_T Accumulator2_DSTATE;          /* '<S18>/Accumulator2' */
  real_T Accumulator_DSTATE;           /* '<S18>/Accumulator' */
  ...
  real_T UnitDelay1_DSTATE_bk;         /* '<S290>/Unit Delay1' */
  ...
  real_T UnitDelay_DSTATE_km;          /* '<S104>/Unit Delay' */
  ...
  real_T timer;                        /* '<S419>/Reefscape_Chart' */
  real_T timer_robot_target;           /* '<S419>/Reefscape_Chart' */
  real_T timer_n;                      /* '<S25>/Reefscape_Auto_Steps' */
  real_T timer_n2;                     /* '<S29>/Reefscape_Chart' */
  real_T timer_robot_target_g;         /* '<S29>/Reefscape_Chart' */
  ...
  boolean_T UnitDelay2_DSTATE;         /* '<S439>/Unit Delay2' */
  boolean_T UnitDelay4_DSTATE;         /* '<S439>/Unit Delay4' */
  boolean_T UnitDelay2_DSTATE_e;       /* '<S25>/Unit Delay2' */
  ...
  boolean_T DelayInput1_DSTATE_kr;     /* '<S27>/Delay Input1' */
  boolean_T UnitDelay_DSTATE_e4;       /* '<S210>/Unit Delay' */
  boolean_T UnitDelay_DSTATE_n;        /* '<S215>/Unit Delay' */
  int8_T Accumulator2_PrevResetState;  /* '<S18>/Accumulator2' */
  int8_T Accumulator_PrevResetState;   /* '<S18>/Accumulator' */
  ...
  uint8_T is_active_c4_Code_Gen_Model; /* '<S419>/Reefscape_Chart' */
  uint8_T is_Elevator_CoralArm_CoralWheel;/* '<S419>/Reefscape_Chart' */
  uint8_T is_Set_Level;                /* '<S419>/Reefscape_Chart' */
  uint8_T is_Coral_Eject;              /* '<S419>/Reefscape_Chart' */
  uint8_T is_Level_2;                  /* '<S419>/Reefscape_Chart' */
  uint8_T is_Level_3;                  /* '<S419>/Reefscape_Chart' */
  uint8_T is_Level_4_Teleop;           /* '<S419>/Reefscape_Chart' */
  uint8_T is_Actions;                  /* '<S419>/Reefscape_Chart' */
  uint8_T is_Set_Level_c;              /* '<S419>/Reefscape_Chart' */
  uint8_T is_Coral_Score_Position;     /* '<S419>/Reefscape_Chart' */
  uint8_T is_Algae_Wheels;             /* '<S419>/Reefscape_Chart' */
  uint8_T is_AT_On_Target_Timer;       /* '<S419>/Reefscape_Chart' */
  uint8_T is_active_c5_Code_Gen_Model; /* '<S25>/Reefscape_Auto_Steps' */
  uint8_T is_c5_Code_Gen_Model;        /* '<S25>/Reefscape_Auto_Steps' */
  ...
  uint8_T is_Path_to_Reef_3;           /* '<S25>/Reefscape_Auto_Steps' */
  uint8_T is_active_c2_Code_Gen_Model; /* '<S29>/Reefscape_Chart' */
  uint8_T is_Elevator_CoralArm_CoralWhe_o;/* '<S29>/Reefscape_Chart' */
  uint8_T is_Set_Level_d;              /* '<S29>/Reefscape_Chart' */
  uint8_T is_Coral_Eject_n;            /* '<S29>/Reefscape_Chart' */
  uint8_T is_Level_2_c;                /* '<S29>/Reefscape_Chart' */
  uint8_T is_Level_3_l;                /* '<S29>/Reefscape_Chart' */
  uint8_T is_Level_4_Teleop_l;         /* '<S29>/Reefscape_Chart' */
  uint8_T is_Actions_n;                /* '<S29>/Reefscape_Chart' */
  uint8_T is_Set_Level_g;              /* '<S29>/Reefscape_Chart' */
  uint8_T is_Coral_Score_Position_m;   /* '<S29>/Reefscape_Chart' */
  uint8_T is_Algae_Wheels_j;           /* '<S29>/Reefscape_Chart' */
  uint8_T is_AT_On_Target_Timer_j;     /* '<S29>/Reefscape_Chart' */
  uint8_T is_active_c9_Code_Gen_Model; /* '<S19>/Chart' */
  uint8_T is_c9_Code_Gen_Model;        /* '<S19>/Chart' */
  boolean_T icLoad;                    /* '<S135>/MemoryX' */
  boolean_T Set_L1;                    /* '<S419>/Reefscape_Chart' */
  boolean_T Set_L2;                    /* '<S419>/Reefscape_Chart' */
  boolean_T Set_L3;                    /* '<S419>/Reefscape_Chart' */
  boolean_T Set_L4;                    /* '<S419>/Reefscape_Chart' */
  boolean_T Set_L1_j;                  /* '<S29>/Reefscape_Chart' */
  boolean_T Set_L2_b;                  /* '<S29>/Reefscape_Chart' */
  boolean_T Set_L3_f;                  /* '<S29>/Reefscape_Chart' */
  boolean_T Set_L4_d;                  /* '<S29>/Reefscape_Chart' */
 ...
 * Block '<S19>/Unit Delay1' : Unused code path elimination
 ...
 * '<S11>'  : 'Code_Gen_Model/RoboRio Controls/End_Game'
 * '<S12>'  : 'Code_Gen_Model/RoboRio Controls/Gyro_Angles'
 * '<S13>'  : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing'
 * '<S14>'  : 'Code_Gen_Model/RoboRio Controls/Internal Feedback'
 * '<S15>'  : 'Code_Gen_Model/RoboRio Controls/Kalman_Filter'
 * '<S16>'  : 'Code_Gen_Model/RoboRio Controls/Limelight_Tag_Corrections'
 * '<S17>'  : 'Code_Gen_Model/RoboRio Controls/Merge'
 * '<S18>'  : 'Code_Gen_Model/RoboRio Controls/Odometry'
 * '<S19>'  : 'Code_Gen_Model/RoboRio Controls/Previous GameState'
 * '<S20>'  : 'Code_Gen_Model/RoboRio Controls/Spline_Path_Following'
 * '<S21>'  : 'Code_Gen_Model/RoboRio Controls/Steer_Module_Offset_Adjustments'
 * '<S22>'  : 'Code_Gen_Model/RoboRio Controls/Swerve_Drive'
 * '<S23>'  : 'Code_Gen_Model/RoboRio Controls/Teleop'
 * '<S24>'  : 'Code_Gen_Model/RoboRio Controls/Test'
 * '<S25>'  : 'Code_Gen_Model/RoboRio Controls/Autonomous/Subsystem'
 * '<S26>'  : 'Code_Gen_Model/RoboRio Controls/Autonomous/Subsystem/April Tag Relative Errors'
 * '<S27>'  : 'Code_Gen_Model/RoboRio Controls/Autonomous/Subsystem/Detect Decrease'
 ...
 * '<S104>' : 'Code_Gen_Model/RoboRio Controls/End_Game/PI and Integral Enable'
 * '<S105>' : 'Code_Gen_Model/RoboRio Controls/End_Game/PI and Integral Enable/Detect Increase'
 * '<S106>' : 'Code_Gen_Model/RoboRio Controls/End_Game/PI and Integral Enable/Saturation Dynamic'
 * '<S107>' : 'Code_Gen_Model/RoboRio Controls/Gyro_Angles/Degrees to Radians'
 * '<S108>' : 'Code_Gen_Model/RoboRio Controls/Gyro_Angles/Detect Increase'
 * '<S109>' : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Constant'
 * '<S110>' : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Constant1'
 * '<S111>' : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Constant2'
 * '<S112>' : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Constant3'
 * '<S113>' : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Constant4'
 * '<S114>' : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Constant5'
 * '<S115>' : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Constant6'
 * '<S116>' : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Constant7'
 * '<S117>' : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Constant8'
 * '<S118>' : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Zero'
 * '<S119>' : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Zero1'
 * '<S120>' : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Zero11'
 * '<S121>' : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Zero12'
 * '<S122>' : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Zero13'
 ...
 * '<S127>' : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Zero2'
 * '<S128>' : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Zero3'
 * '<S129>' : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Zero4'
 * '<S130>' : 'Code_Gen_Model/RoboRio Controls/Human_Input_Pre_Processing/Compare To Zero5'
