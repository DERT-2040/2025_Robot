...
void SimulinkSmartDashboardInterface::PostStepCallback()
{
    ...
    T__Align_Center_a__Entry.SetDouble(Code_Gen_Model_B.Align_Center_a);
    T__Align_Left__Entry.SetDouble(Code_Gen_Model_B.Align_Left);
    T__Align_Left_d__Entry.SetDouble(Code_Gen_Model_B.Align_Left_d);
    ...
    T__Coral_Arm_Angle_Desired_f__Entry.SetDouble(Code_Gen_Model_B.Coral_Arm_Angle_Desired_f);
    ...
    T__Coral_Pickup_Lower_Wait_State_m__Entry.SetDouble(Code_Gen_Model_B.Coral_Pickup_Lower_Wait_State_m);
    ...
    T__Elevator_Height_Desired_h__Entry.SetDouble(Code_Gen_Model_B.Elevator_Height_Desired_h);
    ...
    T__Gamepad_POV_Down_k__Entry.SetDouble(Code_Gen_Model_B.Gamepad_POV_Down_k);
    ...
    T__Translation_Angle_l__Entry.SetDouble(Code_Gen_Model_B.Translation_Angle_l);
    ...
    T__Translation_Speed_g__Entry.SetDouble(Code_Gen_Model_B.Translation_Speed_g);
