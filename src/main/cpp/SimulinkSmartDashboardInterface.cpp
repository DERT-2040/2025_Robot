...
// Inports
    ...
    I__In1__Entry = NTtable_Inport->GetEntry("In1");
...
// Outports
    ...
    O__GameState__Entry = NTtable_Outport->GetEntry("GameState");
...
// Test Points
    ...
    T__Algae_Wheel_Inside_DutyCycle_me__Entry = NTtable_TPoint->GetEntry("Algae_Wheel_Inside_DutyCycle_me");
    T__Algae_Wheel_Outside_DutyCycle_m__Entry = NTtable_TPoint->GetEntry("Algae_Wheel_Outside_DutyCycle_m");
    ...
    T__Coral_Arm_Angle_Desired_h__Entry = NTtable_TPoint->GetEntry("Coral_Arm_Angle_Desired_h");
    ...
    T__Coral_Wheel_DC_f__Entry = NTtable_TPoint->GetEntry("Coral_Wheel_DC_f");
    T__Coral_Wheel_DutyCycle_merge__Entry = NTtable_TPoint->GetEntry("Coral_Wheel_DutyCycle_merge");
    ...
    T__Desired_Pipeline_a__Entry = NTtable_TPoint->GetEntry("Desired_Pipeline_a");
    T__Disable_Wheels__Entry = NTtable_TPoint->GetEntry("Disable_Wheels");
    ...
    T__Elevator_Height_Desired_n__Entry = NTtable_TPoint->GetEntry("Elevator_Height_Desired_n");
    ...
    T__Elevator_LowerPickup_Reset_i__Entry = NTtable_TPoint->GetEntry("Elevator_LowerPickup_Reset_i");
    ...
    T__Enable_Wheels__Entry = NTtable_TPoint->GetEntry("Enable_Wheels");
    ...
    T__Reset_Wheel_Offsets__Entry = NTtable_TPoint->GetEntry("Reset_Wheel_Offsets");
    ...
    T__Set_Algae_Level_m__Entry = NTtable_TPoint->GetEntry("Set_Algae_Level_m");
    T__Set_Coral_Level__Entry = NTtable_TPoint->GetEntry("Set_Coral_Level");
    T__Set_Coral_Level_l__Entry = NTtable_TPoint->GetEntry("Set_Coral_Level_l");
    ...
    T__Swerve_Motors_Disabled__Entry = NTtable_TPoint->GetEntry("Swerve_Motors_Disabled");
...
void SimulinkSmartDashboardInterface::PostStepCallback()
{
    ...
    I__In1__Entry.SetDouble(Code_Gen_Model_U.In1);
    ...
    O__GameState__Entry.SetDouble(Code_Gen_Model_Y.GameState);
    ...
    T__Algae_Wheel_Inside_DutyCycle_me__Entry.SetDouble(Code_Gen_Model_B.Algae_Wheel_Inside_DutyCycle_me);
    T__Algae_Wheel_Outside_DutyCycle_m__Entry.SetDouble(Code_Gen_Model_B.Algae_Wheel_Outside_DutyCycle_m);
    ...
    T__Coral_Arm_Angle_Desired_h__Entry.SetDouble(Code_Gen_Model_B.Coral_Arm_Angle_Desired_h);
    ...
    T__Coral_Wheel_DC_f__Entry.SetDouble(Code_Gen_Model_B.Coral_Wheel_DC_f);
    T__Coral_Wheel_DutyCycle_merge__Entry.SetDouble(Code_Gen_Model_B.Coral_Wheel_DutyCycle_merge);
    ...
    T__Desired_Pipeline_a__Entry.SetDouble(Code_Gen_Model_B.Desired_Pipeline_a);
    T__Disable_Wheels__Entry.SetDouble(Code_Gen_Model_B.Disable_Wheels);
    ...
    T__Elevator_Height_Desired_n__Entry.SetDouble(Code_Gen_Model_B.Elevator_Height_Desired_n);
    ...
    T__Elevator_LowerPickup_Reset_i__Entry.SetDouble(Code_Gen_Model_B.Elevator_LowerPickup_Reset_i);
    ...
    T__Enable_Wheels__Entry.SetDouble(Code_Gen_Model_B.Enable_Wheels);
    ...
    T__Reset_Wheel_Offsets__Entry.SetDouble(Code_Gen_Model_B.Reset_Wheel_Offsets);
    ...
    T__Set_Algae_Level_m__Entry.SetDouble(Code_Gen_Model_B.Set_Algae_Level_m);
    T__Set_Coral_Level__Entry.SetDouble(Code_Gen_Model_B.Set_Coral_Level);
    T__Set_Coral_Level_l__Entry.SetDouble(Code_Gen_Model_B.Set_Coral_Level_l);
    ...
    T__Swerve_Motors_Disabled__Entry.SetDouble(Code_Gen_Model_B.Swerve_Motors_Disabled);
