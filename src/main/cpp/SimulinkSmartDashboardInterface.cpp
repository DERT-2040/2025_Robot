...
SimulinkSmartDashboardInterface::SimulinkSmartDashboardInterface()
{
    ...
    P__Gyro_Calibration_Default__Entry.SetDouble(180);
...
// Test Points
    ...
    T__Align_Center_j__Entry = NTtable_TPoint->GetEntry("Align_Center_j");
    T__Align_Left__Entry = NTtable_TPoint->GetEntry("Align_Left");
    T__Align_Left_p__Entry = NTtable_TPoint->GetEntry("Align_Left_p");
    ...
    T__Compare__Entry = NTtable_TPoint->GetEntry("Compare");
    T__Compare_f__Entry = NTtable_TPoint->GetEntry("Compare_f");
    ...
    T__Coral_Arm_Angle_Desired_c__Entry = NTtable_TPoint->GetEntry("Coral_Arm_Angle_Desired_c");
    ...
    T__Coral_Pickup_Lower_Wait_State_o__Entry = NTtable_TPoint->GetEntry("Coral_Pickup_Lower_Wait_State_o");
    T__Coral_Score_l__Entry = NTtable_TPoint->GetEntry("Coral_Score_l");
    T__Coral_Wheel_DC__Entry = NTtable_TPoint->GetEntry("Coral_Wheel_DC");
    T__Coral_Wheel_DC_e__Entry = NTtable_TPoint->GetEntry("Coral_Wheel_DC_e");
    T__DeadZone__Entry = NTtable_TPoint->GetEntry("DeadZone");
    T__DeadZone1__Entry = NTtable_TPoint->GetEntry("DeadZone1");
    ...
    T__Elevator_Height_Desired_o__Entry = NTtable_TPoint->GetEntry("Elevator_Height_Desired_o");
    ...
    T__Elevator_LowerPickup_Reset_l__Entry = NTtable_TPoint->GetEntry("Elevator_LowerPickup_Reset_l");
    ...
    T__FixPtRelationalOperator__Entry = NTtable_TPoint->GetEntry("FixPtRelationalOperator");
    T__FixPtRelationalOperator_a__Entry = NTtable_TPoint->GetEntry("FixPtRelationalOperator_a");
    T__FixPtRelationalOperator_af__Entry = NTtable_TPoint->GetEntry("FixPtRelationalOperator_af");
    T__FixPtRelationalOperator_d__Entry = NTtable_TPoint->GetEntry("FixPtRelationalOperator_d");
    T__FixPtRelationalOperator_dd__Entry = NTtable_TPoint->GetEntry("FixPtRelationalOperator_dd");
    T__FixPtRelationalOperator_dp__Entry = NTtable_TPoint->GetEntry("FixPtRelationalOperator_dp");
    T__FixPtRelationalOperator_e__Entry = NTtable_TPoint->GetEntry("FixPtRelationalOperator_e");
    T__FixPtRelationalOperator_i__Entry = NTtable_TPoint->GetEntry("FixPtRelationalOperator_i");
    T__FixPtRelationalOperator_j__Entry = NTtable_TPoint->GetEntry("FixPtRelationalOperator_j");
    T__FixPtRelationalOperator_ji__Entry = NTtable_TPoint->GetEntry("FixPtRelationalOperator_ji");
    T__FixPtRelationalOperator_k__Entry = NTtable_TPoint->GetEntry("FixPtRelationalOperator_k");
    T__FixPtRelationalOperator_l__Entry = NTtable_TPoint->GetEntry("FixPtRelationalOperator_l");
    T__FixPtRelationalOperator_lp__Entry = NTtable_TPoint->GetEntry("FixPtRelationalOperator_lp");
    T__FixPtRelationalOperator_m__Entry = NTtable_TPoint->GetEntry("FixPtRelationalOperator_m");
    T__FixPtRelationalOperator_ml__Entry = NTtable_TPoint->GetEntry("FixPtRelationalOperator_ml");
    T__FixPtRelationalOperator_n__Entry = NTtable_TPoint->GetEntry("FixPtRelationalOperator_n");
    T__FixPtRelationalOperator_ne__Entry = NTtable_TPoint->GetEntry("FixPtRelationalOperator_ne");
    T__FixPtRelationalOperator_nw__Entry = NTtable_TPoint->GetEntry("FixPtRelationalOperator_nw");
    T__FixPtRelationalOperator_o__Entry = NTtable_TPoint->GetEntry("FixPtRelationalOperator_o");
    T__FixPtRelationalOperator_oe__Entry = NTtable_TPoint->GetEntry("FixPtRelationalOperator_oe");
    T__FixPtRelationalOperator_oi__Entry = NTtable_TPoint->GetEntry("FixPtRelationalOperator_oi");
    T__FixPtRelationalOperator_p__Entry = NTtable_TPoint->GetEntry("FixPtRelationalOperator_p");
    ...
    T__Gamepad_POV_Down_a__Entry = NTtable_TPoint->GetEntry("Gamepad_POV_Down_a");
    ...
    T__Out_m__Entry = NTtable_TPoint->GetEntry("Out_m");
    ...
    T__Set_Algae_Level_n__Entry = NTtable_TPoint->GetEntry("Set_Algae_Level_n");
    ...
    T__Translation_Angle_g__Entry = NTtable_TPoint->GetEntry("Translation_Angle_g");
    ...
    T__Translation_Speed_l__Entry = NTtable_TPoint->GetEntry("Translation_Speed_l");
    T__Translation_Steering_Cmd__Entry = NTtable_TPoint->GetEntry("Translation_Steering_Cmd");
    T__UnitDelay__Entry = NTtable_TPoint->GetEntry("UnitDelay");
    T__UnitDelay2__Entry = NTtable_TPoint->GetEntry("UnitDelay2");
    T__UnitDelay_b__Entry = NTtable_TPoint->GetEntry("UnitDelay_b");
...
void SimulinkSmartDashboardInterface::PostStepCallback()
{
    ...
    I__BackLeft_Turn_Offset__Entry.SetDouble(Code_Gen_Model_U.BackLeft_Turn_Offset);
    I__BackRight_Drive_Motor_Rev__Entry.SetDouble(Code_Gen_Model_U.BackRight_Drive_Motor_Rev);
    ...
    I__FrontLeft_Turn_Offset__Entry.SetDouble(Code_Gen_Model_U.FrontLeft_Turn_Offset);
    I__FrontRight_Drive_Motor_Rev__Entry.SetDouble(Code_Gen_Model_U.FrontRight_Drive_Motor_Rev);
    I__FrontRight_Drive_Motor_Speed__Entry.SetDouble(Code_Gen_Model_U.FrontRight_Drive_Motor_Speed);
    I__FrontRight_Steer_Rev__Entry.SetDouble(Code_Gen_Model_U.FrontRight_Steer_Rev);
    I__FrontRight_Turn_Offset__Entry.SetDouble(Code_Gen_Model_U.FrontRight_Turn_Offset);
    I__GameState__Entry.SetDouble(Code_Gen_Model_U.GameState);
    I__Gamepad_B1_A__Entry.SetDouble(Code_Gen_Model_U.Gamepad_B1_A);
    I__Gamepad_B2_B__Entry.SetDouble(Code_Gen_Model_U.Gamepad_B2_B);
    I__Gamepad_B3_X__Entry.SetDouble(Code_Gen_Model_U.Gamepad_B3_X);
    I__Gamepad_B4_Y__Entry.SetDouble(Code_Gen_Model_U.Gamepad_B4_Y);
    I__Gamepad_Back__Entry.SetDouble(Code_Gen_Model_U.Gamepad_Back);
    I__Gamepad_LB__Entry.SetDouble(Code_Gen_Model_U.Gamepad_LB);
    I__Gamepad_LT__Entry.SetDouble(Code_Gen_Model_U.Gamepad_LT);
    I__Gamepad_POV__Entry.SetDouble(Code_Gen_Model_U.Gamepad_POV);
    I__Gamepad_RB__Entry.SetDouble(Code_Gen_Model_U.Gamepad_RB);
    I__Gamepad_RT__Entry.SetDouble(Code_Gen_Model_U.Gamepad_RT);
    I__Gamepad_Start__Entry.SetDouble(Code_Gen_Model_U.Gamepad_Start);
    I__Gamepad_Stick_Left_X__Entry.SetDouble(Code_Gen_Model_U.Gamepad_Stick_Left_X);
    I__Gamepad_Stick_Left_Y__Entry.SetDouble(Code_Gen_Model_U.Gamepad_Stick_Left_Y);
    I__Gamepad_Stick_Right_X__Entry.SetDouble(Code_Gen_Model_U.Gamepad_Stick_Right_X);
    I__Gamepad_Stick_Right_Y__Entry.SetDouble(Code_Gen_Model_U.Gamepad_Stick_Right_Y);
    I__Gyro_Angle__Entry.SetDouble(Code_Gen_Model_U.Gyro_Angle);
    I__IsBlueAlliance__Entry.SetDouble(Code_Gen_Model_U.IsBlueAlliance);
    I__Joystick_Left_B1__Entry.SetDouble(Code_Gen_Model_U.Joystick_Left_B1);
    I__Joystick_Left_B10__Entry.SetDouble(Code_Gen_Model_U.Joystick_Left_B10);
    I__Joystick_Left_B11__Entry.SetDouble(Code_Gen_Model_U.Joystick_Left_B11);
    I__Joystick_Left_B12__Entry.SetDouble(Code_Gen_Model_U.Joystick_Left_B12);
    I__Joystick_Left_B13__Entry.SetDouble(Code_Gen_Model_U.Joystick_Left_B13);
    I__Joystick_Left_B14__Entry.SetDouble(Code_Gen_Model_U.Joystick_Left_B14);
    I__Joystick_Left_B15__Entry.SetDouble(Code_Gen_Model_U.Joystick_Left_B15);
    I__Joystick_Left_B16__Entry.SetDouble(Code_Gen_Model_U.Joystick_Left_B16);
    I__Joystick_Left_B2__Entry.SetDouble(Code_Gen_Model_U.Joystick_Left_B2);
    I__Joystick_Left_B3__Entry.SetDouble(Code_Gen_Model_U.Joystick_Left_B3);
    I__Joystick_Left_B4__Entry.SetDouble(Code_Gen_Model_U.Joystick_Left_B4);
    I__Joystick_Left_B5__Entry.SetDouble(Code_Gen_Model_U.Joystick_Left_B5);
    I__Joystick_Left_B6__Entry.SetDouble(Code_Gen_Model_U.Joystick_Left_B6);
    I__Joystick_Left_B7__Entry.SetDouble(Code_Gen_Model_U.Joystick_Left_B7);
    I__Joystick_Left_B8__Entry.SetDouble(Code_Gen_Model_U.Joystick_Left_B8);
    I__Joystick_Left_B9__Entry.SetDouble(Code_Gen_Model_U.Joystick_Left_B9);
    I__Joystick_Left_POV__Entry.SetDouble(Code_Gen_Model_U.Joystick_Left_POV);
    I__Joystick_Left_X__Entry.SetDouble(Code_Gen_Model_U.Joystick_Left_X);
    I__Joystick_Left_Y__Entry.SetDouble(Code_Gen_Model_U.Joystick_Left_Y);
    I__Joystick_Left_Z__Entry.SetDouble(Code_Gen_Model_U.Joystick_Left_Z);
    I__Joystick_Right_B1__Entry.SetDouble(Code_Gen_Model_U.Joystick_Right_B1);
    I__Joystick_Right_B10__Entry.SetDouble(Code_Gen_Model_U.Joystick_Right_B10);
    I__Joystick_Right_B11__Entry.SetDouble(Code_Gen_Model_U.Joystick_Right_B11);
    I__Joystick_Right_B12__Entry.SetDouble(Code_Gen_Model_U.Joystick_Right_B12);
    I__Joystick_Right_B13__Entry.SetDouble(Code_Gen_Model_U.Joystick_Right_B13);
    I__Joystick_Right_B14__Entry.SetDouble(Code_Gen_Model_U.Joystick_Right_B14);
    I__Joystick_Right_B15__Entry.SetDouble(Code_Gen_Model_U.Joystick_Right_B15);
    I__Joystick_Right_B16__Entry.SetDouble(Code_Gen_Model_U.Joystick_Right_B16);
    I__Joystick_Right_B2__Entry.SetDouble(Code_Gen_Model_U.Joystick_Right_B2);
    I__Joystick_Right_B3__Entry.SetDouble(Code_Gen_Model_U.Joystick_Right_B3);
    I__Joystick_Right_B4__Entry.SetDouble(Code_Gen_Model_U.Joystick_Right_B4);
    I__Joystick_Right_B5__Entry.SetDouble(Code_Gen_Model_U.Joystick_Right_B5);
    I__Joystick_Right_B6__Entry.SetDouble(Code_Gen_Model_U.Joystick_Right_B6);
    I__Joystick_Right_B7__Entry.SetDouble(Code_Gen_Model_U.Joystick_Right_B7);
    I__Joystick_Right_B8__Entry.SetDouble(Code_Gen_Model_U.Joystick_Right_B8);
    I__Joystick_Right_B9__Entry.SetDouble(Code_Gen_Model_U.Joystick_Right_B9);
    I__Joystick_Right_POV__Entry.SetDouble(Code_Gen_Model_U.Joystick_Right_POV);
    I__Joystick_Right_X__Entry.SetDouble(Code_Gen_Model_U.Joystick_Right_X);
    I__Joystick_Right_Y__Entry.SetDouble(Code_Gen_Model_U.Joystick_Right_Y);
    I__Joystick_Right_Z__Entry.SetDouble(Code_Gen_Model_U.Joystick_Right_Z);
    I__Limelight_Est_Pose_X__Entry.SetDouble(Code_Gen_Model_U.Limelight_Est_Pose_X);
    I__Limelight_Est_Pose_Y__Entry.SetDouble(Code_Gen_Model_U.Limelight_Est_Pose_Y);
    I__Limelight_Tag_Angle__Entry.SetDouble(Code_Gen_Model_U.Limelight_Tag_Angle);
    I__Limelight_Tag_X__Entry.SetDouble(Code_Gen_Model_U.Limelight_Tag_X);
    ...
    O__FrontRight_Drive_DutyCycle__Entry.SetDouble(Code_Gen_Model_Y.FrontRight_Drive_DutyCycle);
    O__FrontRight_Steer_DutyCycle__Entry.SetDouble(Code_Gen_Model_Y.FrontRight_Steer_DutyCycle);
    ...
    T__AT_Relative_Error_Error_X__Entry.SetDouble(Code_Gen_Model_B.AT_Relative_Error_Error_X);
    T__AT_Relative_Error_Error_Y__Entry.SetDouble(Code_Gen_Model_B.AT_Relative_Error_Error_Y);
    T__Active_GameState__Entry.SetDouble(Code_Gen_Model_B.Active_GameState);
    T__Actuator_Cmd__Entry.SetDouble(Code_Gen_Model_B.Actuator_Cmd);
    T__Align_Center__Entry.SetDouble(Code_Gen_Model_B.Align_Center);
    T__Align_Center_j__Entry.SetDouble(Code_Gen_Model_B.Align_Center_j);
    T__Align_Left__Entry.SetDouble(Code_Gen_Model_B.Align_Left);
    T__Align_Left_p__Entry.SetDouble(Code_Gen_Model_B.Align_Left_p);
    T__Align_Right__Entry.SetDouble(Code_Gen_Model_B.Align_Right);
    T__Auto_AT_On_Target__Entry.SetDouble(Code_Gen_Model_B.Auto_AT_On_Target);
    T__Auto_AT_Relative_Enable__Entry.SetDouble(Code_Gen_Model_B.Auto_AT_Relative_Enable);
    T__Auto_AT_Relative_Error_Angle__Entry.SetDouble(Code_Gen_Model_B.Auto_AT_Relative_Error_Angle);
    T__Auto_AT_Relative_Error_X__Entry.SetDouble(Code_Gen_Model_B.Auto_AT_Relative_Error_X);
    T__Auto_AT_Relative_Error_Y__Entry.SetDouble(Code_Gen_Model_B.Auto_AT_Relative_Error_Y);
    T__Auto_Step_ID__Entry.SetDouble(Code_Gen_Model_B.Auto_Step_ID);
    T__BL_Desired_Module_Angle__Entry.SetDouble(Code_Gen_Model_B.BL_Desired_Module_Angle);
    T__BL_Desired_Wheel_Speed__Entry.SetDouble(Code_Gen_Model_B.BL_Desired_Wheel_Speed);
    T__BL_Desired_Wheel_Speed_in__Entry.SetDouble(Code_Gen_Model_B.BL_Desired_Wheel_Speed_in);
    T__BL_Steer_Module_Angle__Entry.SetDouble(Code_Gen_Model_B.BL_Steer_Module_Angle);
    T__BR_Desired_Module_Angle__Entry.SetDouble(Code_Gen_Model_B.BR_Desired_Module_Angle);
    T__BR_Desired_Wheel_Speed__Entry.SetDouble(Code_Gen_Model_B.BR_Desired_Wheel_Speed);
    T__BR_Desired_Wheel_Speed_in__Entry.SetDouble(Code_Gen_Model_B.BR_Desired_Wheel_Speed_in);
    T__BR_Steer_Module_Angle__Entry.SetDouble(Code_Gen_Model_B.BR_Steer_Module_Angle);
    T__Button_Disable_Wheels__Entry.SetDouble(Code_Gen_Model_B.Button_Disable_Wheels);
    T__Button_Enable_Wheels__Entry.SetDouble(Code_Gen_Model_B.Button_Enable_Wheels);
    T__Button_Reset_Wheel_Offsets__Entry.SetDouble(Code_Gen_Model_B.Button_Reset_Wheel_Offsets);
    T__Compare__Entry.SetDouble(Code_Gen_Model_B.Compare);
    T__Compare_f__Entry.SetDouble(Code_Gen_Model_B.Compare_f);
    T__Coral_ArmAngle_Error__Entry.SetDouble(Code_Gen_Model_B.Coral_ArmAngle_Error);
    T__Coral_Arm_Angle_Desired__Entry.SetDouble(Code_Gen_Model_B.Coral_Arm_Angle_Desired);
    T__Coral_Arm_Angle_Desired_c__Entry.SetDouble(Code_Gen_Model_B.Coral_Arm_Angle_Desired_c);
    T__Coral_Arm_Angle_Desired_merge__Entry.SetDouble(Code_Gen_Model_B.Coral_Arm_Angle_Desired_merge);
    T__Coral_Arm_Angle_Measured__Entry.SetDouble(Code_Gen_Model_B.Coral_Arm_Angle_Measured);
    T__Coral_Pickup_Lower_Wait_State__Entry.SetDouble(Code_Gen_Model_B.Coral_Pickup_Lower_Wait_State);
    T__Coral_Pickup_Lower_Wait_State_o__Entry.SetDouble(Code_Gen_Model_B.Coral_Pickup_Lower_Wait_State_o);
    T__Coral_Score_l__Entry.SetDouble(Code_Gen_Model_B.Coral_Score_l);
    T__Coral_Wheel_DC__Entry.SetDouble(Code_Gen_Model_B.Coral_Wheel_DC);
    T__Coral_Wheel_DC_e__Entry.SetDouble(Code_Gen_Model_B.Coral_Wheel_DC_e);
    T__DeadZone__Entry.SetDouble(Code_Gen_Model_B.DeadZone);
    T__DeadZone1__Entry.SetDouble(Code_Gen_Model_B.DeadZone1);
    ...
    T__Drive_Joystick_Z__Entry.SetDouble(Code_Gen_Model_B.Drive_Joystick_Z);
    T__Drive_Joystick_Z_Mode__Entry.SetDouble(Code_Gen_Model_B.Drive_Joystick_Z_Mode);
    T__Elevator_Error__Entry.SetDouble(Code_Gen_Model_B.Elevator_Error);
    T__Elevator_Height_Desired__Entry.SetDouble(Code_Gen_Model_B.Elevator_Height_Desired);
    T__Elevator_Height_Desired_merge__Entry.SetDouble(Code_Gen_Model_B.Elevator_Height_Desired_merge);
    T__Elevator_Height_Desired_o__Entry.SetDouble(Code_Gen_Model_B.Elevator_Height_Desired_o);
    T__Elevator_Height_Measured__Entry.SetDouble(Code_Gen_Model_B.Elevator_Height_Measured);
    ...
    T__Elevator_LowerPickup_Reset_l__Entry.SetDouble(Code_Gen_Model_B.Elevator_LowerPickup_Reset_l);
    ...
    T__FL_Steer_Module_Angle__Entry.SetDouble(Code_Gen_Model_B.FL_Steer_Module_Angle);
    T__FR_Desired_Module_Angle__Entry.SetDouble(Code_Gen_Model_B.FR_Desired_Module_Angle);
    T__FR_Desired_Wheel_Speed__Entry.SetDouble(Code_Gen_Model_B.FR_Desired_Wheel_Speed);
    T__FR_Desired_Wheel_Speed_in__Entry.SetDouble(Code_Gen_Model_B.FR_Desired_Wheel_Speed_in);
    T__FR_Steer_Module_Angle__Entry.SetDouble(Code_Gen_Model_B.FR_Steer_Module_Angle);
    T__Face_Away_Driver__Entry.SetDouble(Code_Gen_Model_B.Face_Away_Driver);
    T__Face_Left_Driver__Entry.SetDouble(Code_Gen_Model_B.Face_Left_Driver);
    T__Face_Right_Driver__Entry.SetDouble(Code_Gen_Model_B.Face_Right_Driver);
    T__Face_Toward_Driver__Entry.SetDouble(Code_Gen_Model_B.Face_Toward_Driver);
    T__FixPtRelationalOperator__Entry.SetDouble(Code_Gen_Model_B.FixPtRelationalOperator);
    T__FixPtRelationalOperator_a__Entry.SetDouble(Code_Gen_Model_B.FixPtRelationalOperator_a);
    T__FixPtRelationalOperator_af__Entry.SetDouble(Code_Gen_Model_B.FixPtRelationalOperator_af);
    T__FixPtRelationalOperator_d__Entry.SetDouble(Code_Gen_Model_B.FixPtRelationalOperator_d);
    T__FixPtRelationalOperator_dd__Entry.SetDouble(Code_Gen_Model_B.FixPtRelationalOperator_dd);
    T__FixPtRelationalOperator_dp__Entry.SetDouble(Code_Gen_Model_B.FixPtRelationalOperator_dp);
    T__FixPtRelationalOperator_e__Entry.SetDouble(Code_Gen_Model_B.FixPtRelationalOperator_e);
    T__FixPtRelationalOperator_i__Entry.SetDouble(Code_Gen_Model_B.FixPtRelationalOperator_i);
    T__FixPtRelationalOperator_j__Entry.SetDouble(Code_Gen_Model_B.FixPtRelationalOperator_j);
    T__FixPtRelationalOperator_ji__Entry.SetDouble(Code_Gen_Model_B.FixPtRelationalOperator_ji);
    T__FixPtRelationalOperator_k__Entry.SetDouble(Code_Gen_Model_B.FixPtRelationalOperator_k);
    T__FixPtRelationalOperator_l__Entry.SetDouble(Code_Gen_Model_B.FixPtRelationalOperator_l);
    T__FixPtRelationalOperator_lp__Entry.SetDouble(Code_Gen_Model_B.FixPtRelationalOperator_lp);
    T__FixPtRelationalOperator_m__Entry.SetDouble(Code_Gen_Model_B.FixPtRelationalOperator_m);
    T__FixPtRelationalOperator_ml__Entry.SetDouble(Code_Gen_Model_B.FixPtRelationalOperator_ml);
    T__FixPtRelationalOperator_n__Entry.SetDouble(Code_Gen_Model_B.FixPtRelationalOperator_n);
    T__FixPtRelationalOperator_ne__Entry.SetDouble(Code_Gen_Model_B.FixPtRelationalOperator_ne);
    T__FixPtRelationalOperator_nw__Entry.SetDouble(Code_Gen_Model_B.FixPtRelationalOperator_nw);
    T__FixPtRelationalOperator_o__Entry.SetDouble(Code_Gen_Model_B.FixPtRelationalOperator_o);
    T__FixPtRelationalOperator_oe__Entry.SetDouble(Code_Gen_Model_B.FixPtRelationalOperator_oe);
    T__FixPtRelationalOperator_oi__Entry.SetDouble(Code_Gen_Model_B.FixPtRelationalOperator_oi);
    T__FixPtRelationalOperator_p__Entry.SetDouble(Code_Gen_Model_B.FixPtRelationalOperator_p);
    T__Gamepad_B1_A_out__Entry.SetDouble(Code_Gen_Model_B.Gamepad_B1_A_out);
    T__Gamepad_B3_X_out__Entry.SetDouble(Code_Gen_Model_B.Gamepad_B3_X_out);
    T__Gamepad_B4_Y_out__Entry.SetDouble(Code_Gen_Model_B.Gamepad_B4_Y_out);
    T__Gamepad_Back_out__Entry.SetDouble(Code_Gen_Model_B.Gamepad_Back_out);
    T__Gamepad_POV_Down__Entry.SetDouble(Code_Gen_Model_B.Gamepad_POV_Down);
    T__Gamepad_POV_Down_a__Entry.SetDouble(Code_Gen_Model_B.Gamepad_POV_Down_a);
    T__Gamepad_POV_Left__Entry.SetDouble(Code_Gen_Model_B.Gamepad_POV_Left);
    T__Gamepad_POV_Left_p__Entry.SetDouble(Code_Gen_Model_B.Gamepad_POV_Left_p);
    T__Gamepad_POV_Right__Entry.SetDouble(Code_Gen_Model_B.Gamepad_POV_Right);
    T__Gamepad_POV_Up__Entry.SetDouble(Code_Gen_Model_B.Gamepad_POV_Up);
    T__Gamepad_RT_out__Entry.SetDouble(Code_Gen_Model_B.Gamepad_RT_out);
    T__Gamepad_Start_out__Entry.SetDouble(Code_Gen_Model_B.Gamepad_Start_out);
    T__Gyro_Angle_Calibrated_deg__Entry.SetDouble(Code_Gen_Model_B.Gyro_Angle_Calibrated_deg);
    T__Gyro_Angle_Field_rad__Entry.SetDouble(Code_Gen_Model_B.Gyro_Angle_Field_rad);
    T__Gyro_Angle_SPF__Entry.SetDouble(Code_Gen_Model_B.Gyro_Angle_SPF);
    T__Gyro_Angle_rad__Entry.SetDouble(Code_Gen_Model_B.Gyro_Angle_rad);
    T__Is_Absolute_Steering_SPF__Entry.SetDouble(Code_Gen_Model_B.Is_Absolute_Steering_SPF);
    T__Is_Absolute_Translation_SPF__Entry.SetDouble(Code_Gen_Model_B.Is_Absolute_Translation_SPF);
    T__Is_Boosting__Entry.SetDouble(Code_Gen_Model_B.Is_Boosting);
    T__KF_Position_X__Entry.SetDouble(Code_Gen_Model_B.KF_Position_X);
    T__KF_Position_Y__Entry.SetDouble(Code_Gen_Model_B.KF_Position_Y);
    T__Limelight_Tag_Corrected_Angle__Entry.SetDouble(Code_Gen_Model_B.Limelight_Tag_Corrected_Angle);
    ...
    T__Out_m__Entry.SetDouble(Code_Gen_Model_B.Out_m);
    T__Path_Enable__Entry.SetDouble(Code_Gen_Model_B.Path_Enable);
    T__Path_ID__Entry.SetDouble(Code_Gen_Model_B.Path_ID);
    T__Reefscape_Motors_Enable_merge__Entry.SetDouble(Code_Gen_Model_B.Reefscape_Motors_Enable_merge);
    T__Robot_Reached_Destination_l__Entry.SetDouble(Code_Gen_Model_B.Robot_Reached_Destination_l);
    T__Set_Algae_Level__Entry.SetDouble(Code_Gen_Model_B.Set_Algae_Level);
    T__Set_Algae_Level_n__Entry.SetDouble(Code_Gen_Model_B.Set_Algae_Level_n);
    ...
    T__Spline_Out_Of_Bounds__Entry.SetDouble(Code_Gen_Model_B.Spline_Out_Of_Bounds);
    T__Spline_Target_X__Entry.SetDouble(Code_Gen_Model_B.Spline_Target_X);
    T__Spline_Target_Y__Entry.SetDouble(Code_Gen_Model_B.Spline_Target_Y);
    T__State_ID_Auto__Entry.SetDouble(Code_Gen_Model_B.State_ID_Auto);
    T__State_ID_Teleop__Entry.SetDouble(Code_Gen_Model_B.State_ID_Teleop);
    T__Steer_Joystick_X__Entry.SetDouble(Code_Gen_Model_B.Steer_Joystick_X);
    T__Steer_Joystick_Y__Entry.SetDouble(Code_Gen_Model_B.Steer_Joystick_Y);
    T__Steer_Joystick_Z__Entry.SetDouble(Code_Gen_Model_B.Steer_Joystick_Z);
    T__Steering_Abs_Angle__Entry.SetDouble(Code_Gen_Model_B.Steering_Abs_Angle);
    T__Steering_Abs_Angle_Active__Entry.SetDouble(Code_Gen_Model_B.Steering_Abs_Angle_Active);
    T__Steering_Abs_Cmd__Entry.SetDouble(Code_Gen_Model_B.Steering_Abs_Cmd);
    T__Steering_Abs_Cmd_SPF__Entry.SetDouble(Code_Gen_Model_B.Steering_Abs_Cmd_SPF);
    T__Steering_Abs_Gyro__Entry.SetDouble(Code_Gen_Model_B.Steering_Abs_Gyro);
    T__Steering_Abs_Gyro_Latch__Entry.SetDouble(Code_Gen_Model_B.Steering_Abs_Gyro_Latch);
    T__Steering_Localized_Cmd__Entry.SetDouble(Code_Gen_Model_B.Steering_Localized_Cmd);
    T__Steering_Localized_PID__Entry.SetDouble(Code_Gen_Model_B.Steering_Localized_PID);
    T__Steering_Rel_Cmd__Entry.SetDouble(Code_Gen_Model_B.Steering_Rel_Cmd);
    T__Steering_Rel_Cmd_SPF__Entry.SetDouble(Code_Gen_Model_B.Steering_Rel_Cmd_SPF);
    T__Swerve_Drive_Integral_Enable__Entry.SetDouble(Code_Gen_Model_B.Swerve_Drive_Integral_Enable);
    T__Teleop_AT_On_Target__Entry.SetDouble(Code_Gen_Model_B.Teleop_AT_On_Target);
    T__Test_Mode__Entry.SetDouble(Code_Gen_Model_B.Test_Mode);
    T__Translation_Angle__Entry.SetDouble(Code_Gen_Model_B.Translation_Angle);
    T__Translation_Angle_SPF__Entry.SetDouble(Code_Gen_Model_B.Translation_Angle_SPF);
    T__Translation_Angle_g__Entry.SetDouble(Code_Gen_Model_B.Translation_Angle_g);
    T__Translation_Speed__Entry.SetDouble(Code_Gen_Model_B.Translation_Speed);
    T__Translation_Speed_RL__Entry.SetDouble(Code_Gen_Model_B.Translation_Speed_RL);
    T__Translation_Speed_SPF__Entry.SetDouble(Code_Gen_Model_B.Translation_Speed_SPF);
    T__Translation_Speed_l__Entry.SetDouble(Code_Gen_Model_B.Translation_Speed_l);
    T__Translation_Steering_Cmd__Entry.SetDouble(Code_Gen_Model_B.Translation_Steering_Cmd);
    T__UnitDelay__Entry.SetDouble(Code_Gen_Model_B.UnitDelay);
    T__UnitDelay2__Entry.SetDouble(Code_Gen_Model_B.UnitDelay2);
    T__UnitDelay_b__Entry.SetDouble(Code_Gen_Model_B.UnitDelay_b);
    T__WhileIterator__Entry.SetDouble(Code_Gen_Model_B.WhileIterator);
    T__Winch_Cmd__Entry.SetDouble(Code_Gen_Model_B.Winch_Cmd);
}
