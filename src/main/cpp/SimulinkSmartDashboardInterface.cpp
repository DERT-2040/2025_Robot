...
// Test Points
    ...
    __Elevator_Integral_g__Entry = NTtable_TPoint->GetEntry("Elevator_Integral_g");
    ...
    __Elevator_Proportional_f__Entry = NTtable_TPoint->GetEntry("Elevator_Proportional_f");
    ...
    __SignalCopy__Entry = NTtable_TPoint->GetEntry("SignalCopy");
    __SignalCopy1__Entry = NTtable_TPoint->GetEntry("SignalCopy1");
    __SignalCopy2__Entry = NTtable_TPoint->GetEntry("SignalCopy2");
    __SignalCopy3__Entry = NTtable_TPoint->GetEntry("SignalCopy3");
    __SignalCopy4__Entry = NTtable_TPoint->GetEntry("SignalCopy4");
    __SignalCopy5__Entry = NTtable_TPoint->GetEntry("SignalCopy5");
    __SignalCopy6__Entry = NTtable_TPoint->GetEntry("SignalCopy6");
    __SignalCopy7__Entry = NTtable_TPoint->GetEntry("SignalCopy7");
...
void SimulinkSmartDashboardInterface::PostStepCallback()
{
    ...
    __Elevator_Integral_g__Entry.SetDouble(Code_Gen_Model_B.Elevator_Integral_g);
    ...
    __Elevator_Proportional_f__Entry.SetDouble(Code_Gen_Model_B.Elevator_Proportional_f);
    ...
    __SignalCopy__Entry.SetDouble(Code_Gen_Model_B.SignalCopy);
    __SignalCopy1__Entry.SetDouble(Code_Gen_Model_B.SignalCopy1);
    __SignalCopy2__Entry.SetDouble(Code_Gen_Model_B.SignalCopy2);
    __SignalCopy3__Entry.SetDouble(Code_Gen_Model_B.SignalCopy3);
    __SignalCopy4__Entry.SetDouble(Code_Gen_Model_B.SignalCopy4);
    __SignalCopy5__Entry.SetDouble(Code_Gen_Model_B.SignalCopy5);
    __SignalCopy6__Entry.SetDouble(Code_Gen_Model_B.SignalCopy6);
    __SignalCopy7__Entry.SetDouble(Code_Gen_Model_B.SignalCopy7);
