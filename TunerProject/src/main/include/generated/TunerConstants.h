...
class TunerConstants {
    ...
    static constexpr std::string_view kCANBusName = "uno";
...
private:
    ...
    static constexpr int kFrontLeftSteerMotorId = 5;
    static constexpr int kFrontLeftEncoderId = 1;
    static constexpr units::turn_t kFrontLeftEncoderOffset = 0.462890625_tr;
    static constexpr bool kFrontLeftSteerMotorInverted = true;
    static constexpr bool kFrontLeftEncoderInverted = false;

    static constexpr units::inch_t kFrontLeftXPos = 7.3125_in;
    static constexpr units::inch_t kFrontLeftYPos = 7.3125_in;
    ...
    static constexpr units::turn_t kFrontRightEncoderOffset = -0.373291015625_tr;
    static constexpr bool kFrontRightSteerMotorInverted = true;
    static constexpr bool kFrontRightEncoderInverted = false;

    static constexpr units::inch_t kFrontRightXPos = 7.3125_in;
    static constexpr units::inch_t kFrontRightYPos = -7.3125_in;
    ...
    static constexpr units::turn_t kBackLeftEncoderOffset = -0.428955078125_tr;
    static constexpr bool kBackLeftSteerMotorInverted = true;
    static constexpr bool kBackLeftEncoderInverted = false;

    static constexpr units::inch_t kBackLeftXPos = -7.3125_in;
    static constexpr units::inch_t kBackLeftYPos = 7.3125_in;
    ...
    static constexpr units::turn_t kBackRightEncoderOffset = -0.03857421875_tr;
    static constexpr bool kBackRightSteerMotorInverted = true;
    static constexpr bool kBackRightEncoderInverted = false;

    static constexpr units::inch_t kBackRightXPos = -7.3125_in;
    static constexpr units::inch_t kBackRightYPos = -7.3125_in;
