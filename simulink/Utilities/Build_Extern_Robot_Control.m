...
CPPFileID = fopen(append(ProjectRoot,'/../src/main/cpp/SimulinkNetworkTables1.cpp'), 'w');
HFileID = fopen(append(ProjectRoot,'/../src/main/include/SimulinkNetworkTables1.h'), 'w');
if CPPFileID == -1
...
CPPFileContents{end + 1} = '}';
CPPFileContents{end + 1} = ' ';
CPPFileContents{end + 1} = 'void SimulinkNetworkTables1::PreStepCallback() {}';
CPPFileContents{end + 1} = ' ';
CPPFileContents{end + 1} = 'void SimulinkNetworkTables1::PostStepCallback()';
CPPFileContents{end + 1} = '{';
